...
export declare function eventMixin<Events, Base extends Constructor>(
  base: Base,
): {
  new (...args: any[]): {
    ...
    addEventListener<T extends keyof Events>(
      eventType: T,
      listener: (arg0: EventTargetEvent<Events[T]>) => void,
      thisObject?: Object,
    ): EventDescriptor<Events, T>;
    once<T_1 extends keyof Events>(eventType: T_1): Promise<Events[T_1]>;
    removeEventListener<T_2 extends keyof Events>(
      eventType: T_2,
      listener: (arg0: EventTargetEvent<Events[T_2]>) => void,
      thisObject?: Object,
    ): void;
    hasEventListeners(eventType: keyof Events): boolean;
    dispatchEventToListeners<T_3 extends keyof Events>(
      eventType: Platform.TypeScriptUtilities.NoUnion<T_3>,
      ...eventData: EventPayloadToRestParameters<Events, T_3>
    ): void;
  };
} & Base;
export {};
