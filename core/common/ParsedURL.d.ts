 ...
 */
declare type BrandedPathString =
...
export declare class ParsedURL {
  ...
  static urlToRawPathString(
    fileURL: Platform.DevToolsPath.UrlString,
    isWindows?: boolean,
  ): Platform.DevToolsPath.RawPathString;
  static sliceUrlToEncodedPathString(
  ...
  static prepend<DevToolsPathType extends BrandedPathString>(
    prefix: string,
    devToolsPath: DevToolsPathType,
  ): DevToolsPathType;
  ...
  static join<DevToolsPathType extends BrandedPathString>(
    devToolsPaths: DevToolsPathType[],
    separator?: string,
  ): DevToolsPathType;
