...
export declare let load: (
  ...
  allowFileUNCPaths: boolean,
) => void;
export declare function setLoadForTest(
  newLoad: (
    arg0: string,
    arg1: {
      [x: string]: string;
...
export declare function netErrorToMessage(
  netError: number | undefined,
  httpStatusCode: number | undefined,
  netErrorName: string | undefined,
): string | null;
export declare const loadAsStream: (
  url: string,
  headers: {
    [x: string]: string;
  } | null,
