 ...
 */
export declare function getLazilyComputedLocalizedString(
  registeredStrings: I18n.LocalizedStringSet.RegisteredFileStrings,
  id: string,
  values?: i18nTypes.Values,
): () => Platform.UIString.LocalizedString;
/**
 * Retrieve the localized string.
 */
export declare function getLocalizedString(
  registeredStrings: I18n.LocalizedStringSet.RegisteredFileStrings,
  id: string,
  values?: i18nTypes.Values,
): Platform.UIString.LocalizedString;
 ...
 */
export declare function registerUIStrings(
  path: string,
  stringStructure: {
    [key: string]: string;
  },
 ...
 */
export declare function getFormatLocalizedString(
  registeredStrings: I18n.LocalizedStringSet.RegisteredFileStrings,
  stringId: string,
  placeholders: Record<string, Object>,
): Element;
 ...
 */
export declare function getLocalizedLanguageRegion(
