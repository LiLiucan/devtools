...
export declare function sortRange(
  array: number[],
 ...
 */
export declare function lowerBound<T>(
...
export declare function lowerBound<S, T>(
  array: S[],
  needle: T,
 ...
 * define the search window.
 */
export declare function upperBound<T>(
  array: Uint32Array,
  needle: T,
  comparator: (needle: T, b: number) => number,
  left?: number,
...
export declare function upperBound<S, T>(
  array: S[],
  needle: T,
  comparator: (needle: T, b: S) => number,
  left?: number,
