...
export declare class ConsoleMessage {
  ...
  static fromException(
    ...
    messageType?: Protocol.Runtime.ConsoleAPICalledEventType | FrontendMessageType,
    timestamp?: number,
    forceUrl?: Platform.DevToolsPath.UrlString,
    affectedResources?: AffectedResources,
  ): ConsoleMessage;
  runtimeModel(): RuntimeModel | null;
  target(): Target | null;
