...
export declare class EventListener {
  ...
  constructor(
    ...
    location: Location,
    customRemoveFunction: RemoteObject | null,
    origin?: string,
  );
  domDebuggerModel(): DOMDebuggerModel;
  type(): string;
...
export declare class DOMDebuggerManager implements SDKModelObserver<DOMDebuggerModel> {
  #private;
  constructor();
  static instance(opts?: { forceNew: boolean | null }): DOMDebuggerManager;
  ...
  resolveEventListenerBreakpoint(auxData: { eventName: string; targetName: string }): DOMEventListenerBreakpoint | null;
