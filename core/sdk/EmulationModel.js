...
export class EmulationModel extends SDKModel {
  ...
  constructor(target) {
    ...
    if (this.#overlayModelInternal) {
      this.#overlayModelInternal.addEventListener(
        Events.InspectModeWillBeToggled,
        () => {
    ...
    const mediaFeatureColorGamutSetting = Common.Settings.Settings.instance().moduleSetting(
      'emulatedCSSMediaFeatureColorGamut',
    );
    const mediaFeaturePrefersColorSchemeSetting = Common.Settings.Settings.instance().moduleSetting(
      'emulatedCSSMediaFeaturePrefersColorScheme',
    );
    const mediaFeatureForcedColorsSetting = Common.Settings.Settings.instance().moduleSetting(
      'emulatedCSSMediaFeatureForcedColors',
    );
    const mediaFeaturePrefersContrastSetting = Common.Settings.Settings.instance().moduleSetting(
      'emulatedCSSMediaFeaturePrefersContrast',
    );
    const mediaFeaturePrefersReducedDataSetting = Common.Settings.Settings.instance().moduleSetting(
      'emulatedCSSMediaFeaturePrefersReducedData',
    );
    const mediaFeaturePrefersReducedMotionSetting = Common.Settings.Settings.instance().moduleSetting(
