...
export declare class NetworkManager extends SDKModel<EventTypes> {
  ...
  loadNetworkResource(
    ...
    options: Protocol.Network.LoadNetworkResourceOptions,
...
export declare class NetworkDispatcher implements ProtocolProxyApi.NetworkDispatcher {
  ...
  subresourceWebBundleMetadataReceived({
    requestId,
    urls,
  }: Protocol.Network.SubresourceWebBundleMetadataReceivedEvent): void;
  subresourceWebBundleMetadataError({
    requestId,
    errorMessage,
  }: Protocol.Network.SubresourceWebBundleMetadataErrorEvent): void;
...
export declare class MultitargetNetworkManager
  extends Common.ObjectWrapper.ObjectWrapper<MultitargetNetworkManager.EventTypes>
  implements SDKModelObserver<NetworkManager>
{
  #private;
  readonly inflightMainResourceRequests: Map<string, NetworkRequest>;
  constructor();
  static instance(opts?: { forceNew: boolean | null }): MultitargetNetworkManager;
  static dispose(): void;
  ...
  setInterceptionHandlerForPatterns(
    ...
    requestInterceptor: (arg0: InterceptedRequest) => Promise<void>,
  ): Promise<void>;
