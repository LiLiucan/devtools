...
export declare class RemoteObject {
  ...
  static arrayBufferByteLength(
    object: RemoteObject | Protocol.Runtime.RemoteObject | Protocol.Runtime.ObjectPreview,
  ): number;
  static unserializableDescription(object: any): string | null;
  static toCallArgument(
    object: string | number | bigint | boolean | RemoteObject | Protocol.Runtime.RemoteObject | null | undefined,
  ): Protocol.Runtime.CallArgument;
  static loadFromObjectPerProto(
    object: RemoteObject,
  ...
  getAllProperties(
    _accessorPropertiesOnly: boolean,
    _generatePreview: boolean,
  ...
  callFunction<T>(
    ...
    _args?: Protocol.Runtime.CallArgument[],
...
export declare class RemoteObjectImpl extends RemoteObject {
  ...
  doSetObjectPropertyValue(
    result: Protocol.Runtime.RemoteObject,
    name: Protocol.Runtime.CallArgument,
...
export declare class ScopeRemoteObject extends RemoteObjectImpl {
  ...
  doSetObjectPropertyValue(
    result: Protocol.Runtime.RemoteObject,
    argumentName: Protocol.Runtime.CallArgument,
  ): Promise<string | undefined>;
}
