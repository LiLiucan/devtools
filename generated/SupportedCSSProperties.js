...
export const generatedProperties = [
  ...
  {
    longhands: ['scroll-timeline-axis', 'scroll-timeline-name'],
    name: 'scroll-timeline',
  },
  {
    keywords: ['block', 'inline', 'vertical', 'horizontal'],
  ...
  {
    longhands: ['toggle-root', 'toggle-trigger'],
    name: 'toggle',
  },
  {
    keywords: ['none'],
...
export const generatedPropertyValues = {
  ...
  'white-space': {
    values: ['normal', 'pre', 'pre-wrap', 'pre-line', 'nowrap', '-webkit-nowrap', 'break-spaces'],
  },
  width: {
    values: ['auto', 'fit-content', 'min-content', 'max-content'],
  },
