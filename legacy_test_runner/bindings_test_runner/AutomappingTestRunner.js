...
BindingsTestRunner.overrideNetworkModificationTime = function (urlToTime) {
  if (!timeOverrides) {
    ...
    originalRequestMetadata = TestRunner.override(
      Bindings.ContentProviderBasedProject.prototype,
      'requestMetadata',
      overrideTime,
      true,
    );
...
BindingsTestRunner.AutomappingTest = function (workspace) {
  ...
  this.automapping = new Persistence.Automapping(
    this.workspace,
    this._onStatusAdded.bind(this),
    this._onStatusRemoved.bind(this),
  );
