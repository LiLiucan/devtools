...
HeapProfilerTestRunner.createHeapSnapshotMockFactories = function () {
  ...
  HeapProfilerTestRunner.createHeapSnapshotMockRaw = function () {
    return {
      ...
      nodes: [
        0, 0, 1, 0, 20, 0, 2, 1, 1, 2, 2, 2, 0, 2, 1, 2, 3, 3, 8, 0, 2, 1, 3, 4, 4, 10, 0, 1, 1, 4, 5, 5, 5, 14, 0, 1,
        5, 6, 6, 6, 21, 0,
      ],
  ...
  HeapProfilerTestRunner.createHeapSnapshotMockWithDOM = function () {
    return HeapProfilerTestRunner.postprocessHeapSnapshotMock({
      ...
      nodes: [
        2, 0, 1, 4, 1, 11, 2, 2, 1, 11, 3, 3, 2, 5, 4, 0, 2, 6, 5, 1, 1, 1, 6, 0, 1, 2, 7, 1, 1, 4, 8, 2, 1, 8, 9, 0, 1,
        7, 10, 0, 1, 3, 11, 0, 1, 10, 12, 0, 1, 9, 13, 0,
      ],

      edges: [
        0, 1, 4, 0, 2, 8, 0, 3, 12, 0, 4, 16, 0, 1, 20, 0, 2, 24, 0, 1, 24, 0, 2, 28, 1, 3, 32, 0, 1, 36, 0, 1, 40, 2,
        12, 44, 2, 1, 48,
      ],
  ...
  HeapProfilerTestRunner.createHeapSnapshot = function (instanceCount, firstId) {
    ...
    const gcRootsNode = new HeapProfilerTestRunner.HeapNode(
      '(GC roots)',
      0,
      HeapProfilerTestRunner.HeapNode.Type.synthetic,
    );
...
HeapProfilerTestRunner.clickColumn = function (column, callback) {
  ...
  function sortingComplete() {
    HeapProfilerTestRunner.currentGrid().removeEventListener(
      Profiler.HeapSnapshotSortableDataGridEvents.SortingComplete,
      sortingComplete,
      this,
    );
