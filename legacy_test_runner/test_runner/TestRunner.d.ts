 ...
 */
export function addSniffer(
  receiver: Object,
  methodName: string,
  override: Function,
  opt_sticky?: boolean | undefined,
): void;
/**
 * @param {!Object} receiver
 * @param {string} methodName
...
export function evaluateInPage(
  code: string,
  callback: (arg0: any, arg1: Protocol.Runtime.ExceptionDetails | undefined) => void,
): Promise<void>;
/**
 * @param {string} code
...
export function addObject(
  object: Object,
  customFormatters?: TestRunner.CustomFormatters | undefined,
  prefix?: string | undefined,
  firstLinePrefix?: string | undefined,
): void;
/**
 * @param {!Array} array
 * @param {!TestRunner.CustomFormatters=} customFormatters
...
export function dump(
  ...
  customFormatters?: TestRunner.CustomFormatters | undefined,
  prefix?: string | undefined,
  prefixWithName?: string | undefined,
): void;
/**
...
export function waitForEvent(
  eventName: symbol,
  obj: Common.ObjectWrapper.ObjectWrapper<any>,
  condition?: ((arg0: unknown) => boolean) | undefined,
): Promise<any>;
/**
 ...
 * @return {!Promise}
 */
export function waitForUISourceCode(
  urlSuffix: string,
  projectType?: Workspace.Workspace.projectTypes | undefined,
): Promise<any>;
/**
 * @param {!Function} callback
 */
