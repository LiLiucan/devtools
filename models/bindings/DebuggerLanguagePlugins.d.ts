...
export declare class ExtensionRemoteObject extends SDK.RemoteObject.RemoteObject {
  ...
  constructor(
    callFrame: SDK.DebuggerModel.CallFrame,
    extensionObject: Chrome.DevTools.RemoteObject,
    plugin: DebuggerLanguagePlugin,
  );
...
export declare class DebuggerLanguagePluginManager
  implements SDK.TargetManager.SDKModelObserver<SDK.DebuggerModel.DebuggerModel>
{
  ...
  uiLocationToRawLocations(
    ...
    lineNumber: number,
    columnNumber?: number,
  ): Promise<SDK.DebuggerModel.Location[] | null>;
  ...
  getSourcesForScript(script: SDK.Script.Script): Promise<
    | Array<Platform.DevToolsPath.UrlString>
    | {
...
export interface DebuggerLanguagePlugin extends Chrome.DevTools.LanguageExtensionPlugin {
  ...
  evaluate(
    expression: string,
    context: Chrome.DevTools.RawLocation,
    stopId: unknown,
