...
export declare class DebuggerWorkspaceBinding
  implements SDK.TargetManager.SDKModelObserver<SDK.DebuggerModel.DebuggerModel>
{
  ...
  uiLocationToRawLocations(
    ...
    lineNumber: number,
    columnNumber?: number,
  ): Promise<SDK.DebuggerModel.Location[]>;
...
declare class StackTraceTopFrameLocation extends LiveLocationWithPool {
  ...
  static createStackTraceTopFrameLocation(
    rawLocations: SDK.DebuggerModel.Location[],
    binding: DebuggerWorkspaceBinding,
    updateDelegate: (arg0: LiveLocation) => Promise<void>,
    locationPool: LiveLocationPool,
  ): Promise<StackTraceTopFrameLocation>;
  uiLocation(): Promise<Workspace.UISourceCode.UILocation | null>;
  isIgnoreListed(): Promise<boolean>;
  dispose(): void;
