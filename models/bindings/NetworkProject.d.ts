...
export declare class NetworkProjectManager extends Common.ObjectWrapper.ObjectWrapper<EventTypes> {
  private constructor();
  static instance({ forceNew }?: { forceNew: boolean }): NetworkProjectManager;
}
