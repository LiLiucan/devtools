...
export declare class DeviceModeModel
  extends Common.ObjectWrapper.ObjectWrapper<EventTypes>
  implements SDK.TargetManager.SDKModelObserver<SDK.EmulationModel.EmulationModel>
{
  #private;
  private constructor();
  static instance(opts?: { forceNew: null }): DeviceModeModel;
