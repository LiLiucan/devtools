...
export class DeviceModeModel extends Common.ObjectWrapper.ObjectWrapper {
  ...
  constructor() {
    ...
    this.#deviceScaleFactorSettingInternal = Common.Settings.Settings.instance().createSetting(
    ...
    this.#toolbarControlsEnabledSettingInternal = Common.Settings.Settings.instance().createSetting(
      'emulation.toolbarControlsEnabled',
      true,
  ...
  applyDeviceMetrics(
    ...
    const screenOrientationAngle =
      screenOrientation === 'landscapePrimary' /* Protocol.Emulation.ScreenOrientationType.LandscapePrimary */ ? 90 : 0;
    ...
    if (!forceMetricsOverride) {
      ...
      if (
        this.#visiblePageRectInternal.width === pageWidth * scale &&
        this.#visiblePageRectInternal.height === pageHeight * scale &&
  ...
  showHingeIfApplicable(overlayModel) {
    const orientation =
      this.#deviceInternal && this.#modeInternal
