...
export declare class CookieIssue extends Issue {
  ...
  static createIssuesFromCookieIssueDetails(
    cookieIssueDetails: Protocol.Audits.CookieIssueDetails,
  ...
  static codeForCookieIssueDetails(
    ...
    operation: Protocol.Audits.CookieOperation,
    cookieUrl?: string,
  ): string | null;
 ...
 */
export declare function isCausedByThirdParty(
  topFrame: SDK.ResourceTreeModel.ResourceTreeFrame | null,
  cookieUrl?: string,
): boolean;
