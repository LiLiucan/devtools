...
export class CookieIssue extends Issue {
  ...
  static codeForCookieIssueDetails(reason, warningReasons, operation, cookieUrl) {
    ...
    if (
      reason === 'ExcludeSameSiteStrict' /* Protocol.Audits.CookieExclusionReason.ExcludeSameSiteStrict */ ||
...
const issueDescriptions = new Map([
  ...
  ['CookieIssue::ExcludeNavigationContextDowngrade::Insecure', sameSiteExcludeNavigationContextDowngrade(false)],
