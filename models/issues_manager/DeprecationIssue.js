...
const UIStrings = {
   ...
   */
  crossOriginWindowApi:
    'Triggering {PH1} from cross origin iframes has been deprecated and will be removed in the future.',
  /**
  ...
  getDescription() {
    ...
    switch (this.#issueDetails.type) {
      ...
      case 'PrefixedCancelAnimationFrame' /* Protocol.Audits.DeprecationIssueType.PrefixedCancelAnimationFrame */:
        messageFunction = i18nLazyString(UIStrings.vendorSpecificApi, {
          PH1: 'webkitCancelAnimationFrame',
          PH2: 'cancelAnimationFrame',
        });
        break;
      case 'PrefixedRequestAnimationFrame' /* Protocol.Audits.DeprecationIssueType.PrefixedRequestAnimationFrame */:
        messageFunction = i18nLazyString(UIStrings.vendorSpecificApi, {
          PH1: 'webkitRequestAnimationFrame',
          PH2: 'requestAnimationFrame',
        });
        break;
      ...
      case 'PrefixedVideoDisplayingFullscreen' /* Protocol.Audits.DeprecationIssueType.PrefixedVideoDisplayingFullscreen */:
        messageFunction = i18nLazyString(UIStrings.deprecatedWithReplacement, {
          PH1: 'HTMLVideoElement.webkitDisplayingFullscreen',
          PH2: 'Document.fullscreenElement',
        });
        break;
      case 'PrefixedVideoEnterFullScreen' /* Protocol.Audits.DeprecationIssueType.PrefixedVideoEnterFullScreen */:
        messageFunction = i18nLazyString(UIStrings.deprecatedWithReplacement, {
          PH1: 'HTMLVideoElement.webkitEnterFullScreen()',
          PH2: 'Element.requestFullscreen()',
        });
        break;
      case 'PrefixedVideoEnterFullscreen' /* Protocol.Audits.DeprecationIssueType.PrefixedVideoEnterFullscreen */:
        messageFunction = i18nLazyString(UIStrings.deprecatedWithReplacement, {
      ...
      case 'PrefixedVideoExitFullScreen' /* Protocol.Audits.DeprecationIssueType.PrefixedVideoExitFullScreen */:
        messageFunction = i18nLazyString(UIStrings.deprecatedWithReplacement, {
          PH1: 'HTMLVideoElement.webkitExitFullScreen()',
          PH2: 'Document.exitFullscreen()',
        });
        break;
      case 'PrefixedVideoExitFullscreen' /* Protocol.Audits.DeprecationIssueType.PrefixedVideoExitFullscreen */:
        messageFunction = i18nLazyString(UIStrings.deprecatedWithReplacement, {
      ...
      case 'PrefixedVideoSupportsFullscreen' /* Protocol.Audits.DeprecationIssueType.PrefixedVideoSupportsFullscreen */:
        messageFunction = i18nLazyString(UIStrings.deprecatedWithReplacement, {
          PH1: 'HTMLVideoElement.webkitSupportsFullscreen',
          PH2: 'Document.fullscreenEnabled',
        });
        break;
      case 'RangeExpand' /* Protocol.Audits.DeprecationIssueType.RangeExpand */:
        messageFunction = i18nLazyString(UIStrings.deprecatedWithReplacement, {
          PH1: 'Range.expand()',
          PH2: 'Selection.modify()',
        });
        break;
