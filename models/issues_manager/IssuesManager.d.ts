...
export declare class IssuesManager
  ...
  implements SDK.TargetManager.SDKModelObserver<SDK.IssuesModel.IssuesModel>
{
  #private;
  private readonly showThirdPartyIssuesSetting?;
  private readonly hideIssueSetting?;
  constructor(
    showThirdPartyIssuesSetting?: Common.Settings.Setting<boolean> | undefined,
    hideIssueSetting?: Common.Settings.Setting<HideIssueMenuSetting> | undefined,
  );
