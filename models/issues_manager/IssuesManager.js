...
const issueCodeHandlers = new Map([
  ['CookieIssue' /* Protocol.Audits.InspectorIssueCode.CookieIssue */, CookieIssue.fromInspectorIssue],
  [
    'MixedContentIssue' /* Protocol.Audits.InspectorIssueCode.MixedContentIssue */,
    MixedContentIssue.fromInspectorIssue,
  ],
  ['HeavyAdIssue' /* Protocol.Audits.InspectorIssueCode.HeavyAdIssue */, HeavyAdIssue.fromInspectorIssue],
  [
  ...
  ['QuirksModeIssue' /* Protocol.Audits.InspectorIssueCode.QuirksModeIssue */, QuirksModeIssue.fromInspectorIssue],
  [
  ...
  ['GenericIssue' /* Protocol.Audits.InspectorIssueCode.GenericIssue */, GenericIssue.fromInspectorIssue],
  ['DeprecationIssue' /* Protocol.Audits.InspectorIssueCode.DeprecationIssue */, DeprecationIssue.fromInspectorIssue],
  ['ClientHintIssue' /* Protocol.Audits.InspectorIssueCode.ClientHintIssue */, ClientHintIssue.fromInspectorIssue],
  [
...
export function getHideIssueByCodeSetting() {
  return Common.Settings.Settings.instance().createSetting(
    'HideIssueByCodeSetting-Experiment-2021',
...
export class IssuesManager extends Common.ObjectWrapper.ObjectWrapper {
  ...
  constructor(showThirdPartyIssuesSetting, hideIssueSetting) {
    ...
    SDK.FrameManager.FrameManager.instance().addEventListener(
      SDK.FrameManager.Events.TopFrameNavigated,
      this.#onTopFrameNavigated,
      this,
    );
    SDK.FrameManager.FrameManager.instance().addEventListener(
  ...
  modelAdded(issuesModel) {
    const listener = issuesModel.addEventListener(
      'IssueAdded' /* SDK.IssuesModel.Events.IssueAdded */,
