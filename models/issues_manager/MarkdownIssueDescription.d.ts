...
export declare function createIssueDescriptionFromMarkdown(
  description: MarkdownIssueDescription,
): Promise<IssueDescription>;
/**
 * This function is exported separately for unit testing.
 */
export declare function createIssueDescriptionFromRawMarkdown(
  markdown: string,
  description: MarkdownIssueDescription,
): IssueDescription;
/**
...
export declare function getIssueTitleFromMarkdownDescription(
  description: MarkdownIssueDescription,
): Promise<string | null>;
