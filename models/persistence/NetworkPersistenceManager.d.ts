...
export declare class NetworkPersistenceManager
  ...
  implements SDK.TargetManager.Observer
{
  ...
  mergeHeaders(
    baseHeaders: Protocol.Fetch.HeaderEntry[],
    overrideHeaders: Protocol.Fetch.HeaderEntry[],
