...
export declare const scopeIdentifiers: (
  functionScope: SDK.DebuggerModel.ScopeChainEntry | null,
  scope: SDK.DebuggerModel.ScopeChainEntry,
) => Promise<{
  freeVariables: IdentifierPositions[];
  boundVariables: IdentifierPositions[];
} | null>;
export declare const resolveScopeChain: (
  callFrame: SDK.DebuggerModel.CallFrame | null,
) => Promise<SDK.DebuggerModel.ScopeChainEntry[] | null>;
export declare const allVariablesInCallFrame: (callFrame: SDK.DebuggerModel.CallFrame) => Promise<Map<string, string>>;
export declare const resolveExpression: (
...
export declare const resolveThisObject: (
  callFrame: SDK.DebuggerModel.CallFrame | null,
...
export declare function resolveProfileFrameFunctionName(
