...
export interface Project {
  ...
  rename(
    ...
    callback: (
      arg0: boolean,
      arg1?: string,
      arg2?: Platform.DevToolsPath.UrlString,
      arg3?: Common.ResourceType.ResourceType,
    ) => void,
  ): void;
...
export declare class WorkspaceImpl extends Common.ObjectWrapper.ObjectWrapper<EventTypes> {
  ...
  private constructor();
  static instance(opts?: { forceNew: boolean | null }): WorkspaceImpl;
