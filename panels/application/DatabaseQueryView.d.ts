...
declare const DatabaseQueryView_base: (new (...args: any[]) => {
  ...
  addEventListener<T extends Events.SchemaUpdated>(
    eventType: T,
  ...
  removeEventListener<T_2 extends Events.SchemaUpdated>(
    eventType: T_2,
  ...
  dispatchEventToListeners<T_3 extends Events.SchemaUpdated>(
