    ...
    this.#parsedTokenDetails = [
      {
        ...
        value: this.#renderTokenField(
          ...
          this.#tokenWithStatus.status === 'WrongOrigin' /* Protocol.Page.OriginTrialTokenStatus.WrongOrigin */,
        ),
      },
      {
        ...
        value: this.#renderTokenField(
          ...
          this.#tokenWithStatus.status === 'Expired' /* Protocol.Page.OriginTrialTokenStatus.Expired */,
        ),
      },
      {
    ...
    const tokenDetails = [
      {
        ...
        value: LitHtml.html`
          ...
          style:
            this.#tokenWithStatus.status === 'Success' /* Protocol.Page.OriginTrialTokenStatus.Success */
              ? 'success'
              : 'error',
        }}></${Badge.litTagName}>`,
      },
