...
declare const ChangesSidebar_base: (new (...args: any[]) => {
  ...
  addEventListener<T extends Events.SelectedUISourceCodeChanged>(
    eventType: T,
  ...
  removeEventListener<T_2 extends Events.SelectedUISourceCodeChanged>(
    eventType: T_2,
  ...
  dispatchEventToListeners<T_3 extends Events.SelectedUISourceCodeChanged>(
