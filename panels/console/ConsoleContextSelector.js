...
export class ConsoleContextSelector {
  ...
  constructor() {
    ...
    this.items.addEventListener(UI.ListModel.Events.ItemsReplaced, () =>
      this.toolbarItemInternal.setEnabled(Boolean(this.items.length)),
    );
  ...
  createElementForItem(item) {
    ...
    const shadowRoot = UI.Utils.createShadowRootWithCoreStyles(element, {
      cssFile: [consoleContextSelectorStyles],
