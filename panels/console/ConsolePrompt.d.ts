...
declare const ConsolePrompt_base: (new (...args: any[]) => {
  ...
  addEventListener<T extends Events.TextChanged>(
    eventType: T,
  ...
  removeEventListener<T_2 extends Events.TextChanged>(
    eventType: T_2,
  ...
  dispatchEventToListeners<T_3 extends Events.TextChanged>(
