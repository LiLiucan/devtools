...
declare const ConsoleSidebar_base: (new (...args: any[]) => {
  ...
  addEventListener<T extends Events.FilterSelected>(
    eventType: T,
  ...
  removeEventListener<T_2 extends Events.FilterSelected>(
    eventType: T_2,
  ...
  dispatchEventToListeners<T_3 extends Events.FilterSelected>(
