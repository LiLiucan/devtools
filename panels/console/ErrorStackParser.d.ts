 ...
 */
export declare function parseSourcePositionsFromErrorStack(
 ...
 */
export declare function augmentErrorStackWithScriptIds(
  parsedFrames: ParsedErrorFrame[],
  protocolStackTrace: Protocol.Runtime.StackTrace,
): void;
