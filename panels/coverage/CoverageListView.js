  ...
  createCell(columnId) {
    ...
    switch (columnId) {
      ...
      case 'unusedSize': {
        ...
        const unusedAccessibleName = i18nString(UIStrings.sBytesS, {
          n: unusedSize,
      ...
      case 'bars': {
        ...
        if (this.coverageInfo.unusedSize() > 0) {
          ...
          if (this.coverageInfo.type() & 4 /* CoverageType.JavaScriptPerFunction */) {
            UI.Tooltip.Tooltip.install(
              unusedSizeBar,
              i18nString(UIStrings.sBytesSBelongToFunctionsThatHave, {
            ...
            UI.Tooltip.Tooltip.install(
              unusedSizeBar,
              i18nString(UIStrings.sBytesSBelongToBlocksOf, {
                PH1: this.coverageInfo.unusedSize(),
                PH2: unusedPercent,
              }),
            );
        ...
        if (this.coverageInfo.usedSize() > 0) {
          ...
          if (this.coverageInfo.type() & 4 /* CoverageType.JavaScriptPerFunction */) {
            UI.Tooltip.Tooltip.install(
              usedSizeBar,
              i18nString(UIStrings.sBytesSBelongToFunctionsThatHaveExecuted, {
            ...
            UI.Tooltip.Tooltip.install(
              usedSizeBar,
              i18nString(UIStrings.sBytesSBelongToBlocksOfJavascript, {
                PH1: this.coverageInfo.usedSize(),
                PH2: usedPercent,
              }),
            );
