...
export class CoverageModel extends SDK.SDKModel.SDKModel {
  ...
  async pollAndCallback() {
    ...
    console.assert(
      this.suspensionState !== 'Suspended' /* SuspensionState.Suspended */ || Boolean(this.performanceTraceRecording),
...
function locationCompare(a, b) {
  ...
  return (
    Number.parseInt(aLine, 10) - Number.parseInt(bLine, 10) || Number.parseInt(aPos, 10) - Number.parseInt(bPos, 10)
  );
}
