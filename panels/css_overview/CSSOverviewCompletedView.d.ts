...
declare const DetailsView_base: (new (...args: any[]) => {
  ...
  addEventListener<T extends Events.TabClosed>(
    eventType: T,
   ...
   */;
  removeEventListener<T_2 extends Events.TabClosed>(
    eventType: T_2,
  ...
  dispatchEventToListeners<T_3 extends Events.TabClosed>(
...
export declare class ElementNode extends DataGrid.SortableDataGrid.SortableDataGridNode<ElementNode> {
  ...
  constructor(
    ...
    frontendNode: SDK.DOMModel.DOMNode | null | undefined,
    linkifier: Components.Linkifier.Linkifier,
    cssModel: SDK.CSSModel.CSSModel,
  );
