...
export class CSSOverviewPanel extends UI.Panel.Panel {
  ...
  constructor() {
    ...
    this.#startView.addEventListener('overviewstartrequested', () =>
      this.#controller.dispatchEventToListeners('RequestOverviewStart' /* Events.RequestOverviewStart */),
    );
    ...
    this.#controller.addEventListener(
      'RequestOverviewStart' /* Events.RequestOverviewStart */,
      (_event) => {
    ...
    this.#controller.addEventListener(
      'OverviewCompleted' /* Events.OverviewCompleted */,
      this.#overviewCompleted,
      this,
    );
    this.#controller.addEventListener('Reset' /* Events.Reset */, this.#reset, this);
    this.#controller.addEventListener(
      'RequestNodeHighlight' /* Events.RequestNodeHighlight */,
      this.#requestNodeHighlight,
      this,
    );
    this.#reset();
  }
  ...
  async #startOverview() {
    ...
    const [
      ...
      mediaQueries,
    ] = await Promise.all([model.getGlobalStylesheetStats(), model.getNodeStyleStats(), model.getMediaQueries()]);
    if (elementCount) {
