...
export class DeveloperResourcesView extends UI.Widget.VBox {
  ...
  constructor() {
    ...
    this.filterInput = new UI.Toolbar.ToolbarInput(
      i18nString(UIStrings.enterTextToSearchTheUrlAndError),
    ...
    const loadThroughTargetCheckbox = new UI.Toolbar.ToolbarSettingCheckbox(
      loadThroughTarget,
      i18nString(UIStrings.loadHttpsDeveloperResources),
  ...
  isVisible(item) {
    return (
      !this.textFilterRegExp ||
      this.textFilterRegExp.test(item.url) ||
