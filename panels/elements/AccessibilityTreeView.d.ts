...
export declare class AccessibilityTreeView
  extends UI.Widget.VBox
  implements SDK.TargetManager.SDKModelObserver<SDK.AccessibilityModel.AccessibilityModel>
{
  ...
  treeUpdated({
    ...
    SDK.AccessibilityModel.EventTypes[SDK.AccessibilityModel.Events.TreeUpdated]
  >): void;
