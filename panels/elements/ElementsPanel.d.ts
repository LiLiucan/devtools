...
export declare class ElementsPanel
...
export declare class DOMNodeRevealer implements Common.Revealer.Revealer {
  static instance(opts?: { forceNew: boolean | null }): DOMNodeRevealer;
...
export declare class CSSPropertyRevealer implements Common.Revealer.Revealer {
  static instance(opts?: { forceNew: boolean | null }): CSSPropertyRevealer;
...
export declare class PseudoStateMarkerDecorator implements MarkerDecorator {
  static instance(opts?: { forceNew: boolean | null }): PseudoStateMarkerDecorator;
