...
declare const ElementsTreeOutline_base: (new (...args: any[]) => {
  ...
  addEventListener<T extends keyof ElementsTreeOutline.EventTypes>(
    eventType: T,
    listener: (arg0: Common.EventTarget.EventTargetEvent<ElementsTreeOutline.EventTypes[T]>) => void,
    thisObject?: Object | undefined,
  ): Common.EventTarget.EventDescriptor<ElementsTreeOutline.EventTypes, T>;
  once<T_1 extends keyof ElementsTreeOutline.EventTypes>(eventType: T_1): Promise<ElementsTreeOutline.EventTypes[T_1]>;
  removeEventListener<T_2 extends keyof ElementsTreeOutline.EventTypes>(
    eventType: T_2,
    listener: (arg0: Common.EventTarget.EventTargetEvent<ElementsTreeOutline.EventTypes[T_2]>) => void,
    thisObject?: Object | undefined,
  ): void;
  hasEventListeners(eventType: keyof ElementsTreeOutline.EventTypes): boolean;
  dispatchEventToListeners<T_3 extends keyof ElementsTreeOutline.EventTypes>(
    eventType: import('../../core/platform/typescript-utilities.js').NoUnion<T_3>,
    ...eventData: Common.EventTarget.EventPayloadToRestParameters<ElementsTreeOutline.EventTypes, T_3>
  ): void;
}) &
...
export declare class ElementsTreeOutline extends ElementsTreeOutline_base {
  ...
  selectNodeAfterEdit(
    wasExpanded: boolean,
    error: string | null,
    newNode: SDK.DOMModel.DOMNode | null,
  ): ElementsTreeElement | null;
  /**
  ...
  insertChildElement(
    treeElement: ElementsTreeElement | TopLayerContainer,
    child: SDK.DOMModel.DOMNode,
    index: number,
...
export declare class Renderer implements UI.UIUtils.Renderer {
  static instance(opts?: { forceNew: boolean | null }): Renderer;
