...
export declare class InspectElementModeController
  implements SDK.TargetManager.SDKModelObserver<SDK.OverlayModel.OverlayModel>
{
  private readonly toggleSearchAction;
  private mode;
  private readonly showDetailedInspectTooltipSetting;
  constructor();
  static instance({ forceNew }?: { forceNew: boolean }): InspectElementModeController;
