...
const CategorizedProperties = new Map([
  ...
  ['Table' /* Category.Table */, ['border-collapse', 'border-spacing', 'caption-side', 'empty-cells', 'table-layout']],
  ['Generated Content' /* Category.GeneratedContent */, ['content', 'quotes', 'counter-reset', 'counter-increment']],
]);
