...
export declare class StylesSidebarPane extends StylesSidebarPane_base {
  ...
  static createPropertyFilterElement(
    placeholder: string,
    container: Element,
    filterCallback: (arg0: RegExp | null) => void,
  ): Element;
  ...
  addBlankSection(
    insertAfterSection: StylePropertiesSection,
    styleSheetId: Protocol.CSS.StyleSheetId,
    ruleLocation: TextUtils.TextRange.TextRange,
  ): void;
...
export declare class SectionBlock {
  ...
  static createInheritedPseudoTypeBlock(
    pseudoType: Protocol.DOM.PseudoType,
    pseudoArgument: string | null,
...
export declare class ButtonProvider implements UI.Toolbar.Provider {
  ...
  private constructor();
  static instance(opts?: { forceNew: boolean | null }): ButtonProvider;
  private clicked;
  private longClicked;
