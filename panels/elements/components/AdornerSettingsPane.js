    ...
    for (const [adorner, isEnabled] of this.#settings) {
      ...
      settingTemplates.push(html`
        <label class="setting" title=${adorner}>
          <input class="adorner-status" type="checkbox" name=${adorner} .checked=${isEnabled} data-adorner=${adorner} />
    ...
    render(
      html`
        <div class="adorner-settings-pane" tabindex="-1">
          ...
          <div class="setting-list" @change=${this.#onChange}>${settingTemplates}</div>
