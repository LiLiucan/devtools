...
export function rotateAlignContentIcon(iconName, direction) {
  return {
    iconName,
    rotate:
      direction === PhysicalDirection.RIGHT_TO_LEFT ? 90 : direction === PhysicalDirection.LEFT_TO_RIGHT ? -90 : 0,
    scaleX: 1,
    scaleY: 1,
  };
}
export function rotateJustifyContentIcon(iconName, direction) {
  return {
    iconName,
    rotate:
      direction === PhysicalDirection.TOP_TO_BOTTOM ? 90 : direction === PhysicalDirection.BOTTOM_TO_TOP ? -90 : 0,
