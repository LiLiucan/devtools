...
export class StylePropertyEditor extends HTMLElement {
  ...
  #render() {
    ...
    // clang-format off
    render(
      html` <div class="container">${this.editableProperties.map((prop) => this.#renderProperty(prop))}</div> `,
      this.#shadow,
      {
        host: this,
      },
  ...
  #renderButton(propertyValue, propertyName, selected = false) {
    ...
    return html`<button title=${title} class=${classes} @click=${() =>
      this.#onButtonClick(propertyName, propertyValue, selected)}>
...
export const FlexboxEditableProperties = [
  ...
  },
  {
    ...
    propertyValues: ['center', 'flex-start', 'flex-end', 'space-around', 'space-between', 'stretch'],
  },
  {
    propertyName: 'justify-content',
    propertyValues: ['center', 'flex-start', 'flex-end', 'space-between', 'space-around', 'space-evenly'],
  },
  {
...
export const GridEditableProperties = [
  {
    propertyName: 'align-content',
    propertyValues: ['center', 'space-between', 'space-around', 'space-evenly', 'stretch'],
  },
  {
    propertyName: 'justify-content',
    propertyValues: ['center', 'start', 'end', 'space-between', 'space-around', 'space-evenly'],
  },
  {
    propertyName: 'align-items',
