...
export class AdvancedApp {
  ...
  constructor() {
    UI.DockController.DockController.instance().addEventListener(
      'BeforeDockSideChanged' /* UI.DockController.Events.BeforeDockSideChanged */,
  ...
  presentUI(document) {
    ...
    UI.DockController.DockController.instance().addEventListener(
      'DockSideChanged' /* UI.DockController.Events.DockSideChanged */,
      this.onDockSideChange,
      this,
    );
    UI.DockController.DockController.instance().addEventListener(
      'AfterDockSideChanged' /* UI.DockController.Events.AfterDockSideChanged */,
