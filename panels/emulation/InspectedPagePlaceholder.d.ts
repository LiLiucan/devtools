...
declare const InspectedPagePlaceholder_base: (new (...args: any[]) => {
  ...
  addEventListener<T extends Events.Update>(
    eventType: T,
...
export declare class InspectedPagePlaceholder extends InspectedPagePlaceholder_base {
  private updateId?;
  constructor();
  static instance(opts?: { forceNew: null }): InspectedPagePlaceholder;
  onResize(): void;
