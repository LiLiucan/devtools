...
export class ObjectEventListenerBar extends UI.TreeOutline.TreeElement {
  ...
  setTitle(object, linkifier) {
    ...
    const linkElement = linkifier.linkifyRawLocation(
      this.eventListenerInternal.location(),
      this.eventListenerInternal.sourceURL(),
    );
    ...
    this.listItemElement.addEventListener('contextmenu', (event) => {
      ...
      if (object.subtype === 'node') {
        menu
          .defaultSection()
          .appendItem(i18nString(UIStrings.revealInElementsPanel), () => Common.Revealer.reveal(object));
      }
      menu
        .defaultSection()
        .appendItem(
      ...
      menu
        ...
        .appendCheckboxItem(
          ...
          this.togglePassiveListener.bind(this),
          this.eventListenerInternal.passive(),
