...
export declare abstract class AffectedResourcesView extends UI.TreeOutline.TreeElement {
  ...
  protected createFrameCell(
    frameId: Protocol.Page.FrameId,
    issueCategory: IssuesManager.Issue.IssueCategory,
  ): HTMLElement;
  protected createRequestCell(
    affectedRequest: Protocol.Audits.AffectedRequest,
    options?: CreateRequestCellOptions,
  ): HTMLElement;
  protected createElementCell(
  ...
  protected appendSourceLocation(
    ...
    sourceLocation:
      ...
      | undefined,
    target: SDK.Target.Target | null | undefined,
  ): void;
