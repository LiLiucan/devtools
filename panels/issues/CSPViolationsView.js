...
export class CSPViolationsView extends UI.Widget.VBox {
  ...
  constructor() {
    ...
    levelMenuButton.addOption(
      'Trusted Type Policy',
      IssuesManager.ContentSecurityPolicyIssue.trustedTypesPolicyViolationCode,
      true,
    );
    levelMenuButton.addOption(
      'Trusted Type Sink',
      IssuesManager.ContentSecurityPolicyIssue.trustedTypesSinkViolationCode,
      true,
    );
    ...
    this.#issuesManager.addEventListener(
      'IssueAdded' /* IssuesManager.IssuesManager.Events.IssueAdded */,
      this.#onIssueAdded,
      this,
    );
    this.#issuesManager.addEventListener(
      'FullUpdateRequired' /* IssuesManager.IssuesManager.Events.FullUpdateRequired */,
