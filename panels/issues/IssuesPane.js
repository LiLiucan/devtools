...
export class IssuesPane extends UI.Widget.VBox {
  ...
  constructor() {
    ...
    this.#aggregator.addEventListener(
      'AggregatedIssueUpdated' /* IssueAggregatorEvents.AggregatedIssueUpdated */,
      this.#issueUpdated,
      this,
    );
    this.#aggregator.addEventListener(
      'FullUpdateRequired' /* IssueAggregatorEvents.FullUpdateRequired */,
      this.#onFullUpdate,
      this,
    );
  ...
  async #updateIssueView(issue) {
    ...
    if (!issueView) {
      ...
      const markdownDescription = await IssuesManager.MarkdownIssueDescription.createIssueDescriptionFromMarkdown(
        description,
      );
