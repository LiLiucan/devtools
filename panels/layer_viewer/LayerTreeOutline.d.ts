...
declare const LayerTreeOutline_base: (new (...args: any[]) => {
  ...
  addEventListener<T extends Events.PaintProfilerRequested>(
    eventType: T,
  ...
  removeEventListener<T_2 extends Events.PaintProfilerRequested>(
    eventType: T_2,
  ...
  dispatchEventToListeners<T_3 extends Events.PaintProfilerRequested>(
...
export declare class LayerTreeOutline
  extends LayerTreeOutline_base
  implements Common.EventTarget.EventTarget<EventTypes>, LayerView
{
