...
export class StatusView {
  ...
  render() {
    const dialogRoot = UI.Utils.createShadowRootWithCoreStyles(this.dialog.contentElement, {
...
`;
    if (this.statusText) {
      UI.UIUtils.createTextChild(
        this.statusText.createChild('p'),
        i18nString(UIStrings.ifThisIssueIsReproduciblePlease),
      );
