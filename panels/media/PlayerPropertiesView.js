...
export class PlayerPropertiesView extends UI.Widget.VBox {
  ...
  populateAttributesAndElements() {
    ...
    this.attributeMap.set(
      'kIsPlatformVideoDecoder' /* PlayerPropertyKeys.IsPlatformVideoDecoder */,
    ...
    this.attributeMap.set(
      'kIsPlatformVideoEncoder' /* PlayerPropertyKeys.IsPlatformVideoEncoder */,
    ...
    this.attributeMap.set(
      'kIsVideoDecryptingDemuxerStream' /* PlayerPropertyKeys.IsVideoDecryptingDemuxerStream */,
      videoDDS,
    );
    ...
    this.attributeMap.set(
      'kIsPlatformAudioDecoder' /* PlayerPropertyKeys.IsPlatformAudioDecoder */,
    ...
    this.attributeMap.set(
      'kIsAudioDecryptingDemuxerStream' /* PlayerPropertyKeys.IsAudioDecryptingDemuxerStream */,
      audioDDS,
    );
