...
export class BinaryResourceView extends UI.Widget.VBox {
  ...
  constructor(base64content, contentUrl, resourceType) {
    super();
    this.binaryResourceViewFactory = new SourceFrame.BinaryResourceViewFactory.BinaryResourceViewFactory(
      base64content,
      contentUrl,
      resourceType,
    );
  ...
  getCurrentViewObject() {
    ...
    console.assert(
      ...
      `No binary view found for binary view type found in setting 'binaryViewType': ${this.binaryViewTypeSetting.get()}`,
    );
