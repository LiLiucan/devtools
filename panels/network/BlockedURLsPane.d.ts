...
export declare class BlockedURLsPane
  ...
  implements UI.ListWidget.Delegate<SDK.NetworkManager.BlockedPattern>
{
  ...
  constructor();
  static instance(opts?: { forceNew: boolean | null }): BlockedURLsPane;
  ...
  commitEdit(
    item: SDK.NetworkManager.BlockedPattern,
    editor: UI.ListWidget.Editor<SDK.NetworkManager.BlockedPattern>,
    isNew: boolean,
  ): void;
