...
export class NetworkLogViewColumns {
  ...
  setupDataGrid() {
    ...
    this.dataGridInternal.element.addEventListener(
      'mousedown',
      (event) => {
  ...
  createWaterfallHeader() {
    ...
    this.waterfallHeaderElement.addEventListener('contextmenu', (event) =>
      this.innerHeaderContextMenu(new UI.ContextMenu.ContextMenu(event)),
    );
  ...
  innerHeaderContextMenu(contextMenu) {
    ...
    for (const columnConfig of nonResponseHeadersWithoutGroup) {
      ...
      contextMenu
        .headerSection()
        .appendCheckboxItem(title, this.toggleColumnVisibility.bind(this, columnConfig), columnConfig.visible);
    }
    ...
    responseSubMenu
      .footerSection()
      .appendItem(i18nString(UIStrings.manageHeaderColumns), this.manageCustomHeaderDialog.bind(this));
  ...
  manageCustomHeaderDialog() {
    ...
    const manageCustomHeaders = new NetworkManageCustomHeadersView(
      customHeaders,
      (headerTitle) => Boolean(this.addCustomHeader(headerTitle)),
      this.changeCustomHeader.bind(this),
