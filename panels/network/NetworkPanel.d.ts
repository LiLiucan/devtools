...
export declare class NetworkPanel
  ...
  implements UI.ContextMenu.Provider, UI.View.ViewLocationResolver
{
  ...
  constructor();
  static instance(opts?: { forceNew: boolean | null }): NetworkPanel;
...
export declare class NetworkLogWithFilterRevealer implements Common.Revealer.Revealer {
  static instance(opts?: { forceNew: boolean | null }): NetworkLogWithFilterRevealer;
  reveal(request: Object): Promise<void>;
}
