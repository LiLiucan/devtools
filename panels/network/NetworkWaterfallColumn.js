...
export class NetworkWaterfallColumn extends UI.Widget.VBox {
  ...
  static buildRequestTimeRangeStyle() {
    ...
    styleMap.set(types.Queueing, {
      fillStyle: RequestTimeRangeNameToColor[types.Queueing],
      lineWidth: 2,
    ...
    styleMap.set(types.ServiceWorkerPreparation, {
      fillStyle: RequestTimeRangeNameToColor[types.ServiceWorkerPreparation],
    });
  ...
  static buildResourceTypeStyle() {
    ...
    for (const resourceType of Object.values(Common.ResourceType.resourceTypes)) {
      ...
      waitingStyleMap.set(
        ...
        // @ts-expect-error
        resourceType,
        { fillStyle: toWaitingColor(color), lineWidth: 1, borderColor: borderColor },
      );
      // TODO(crbug.com/1172300) Ignored during the jsdoc to ts migration)
      // @ts-expect-error
