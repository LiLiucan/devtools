      ...
      for (let i = 0; i < header.signatures.length; ++i) {
        ...
        signatureCategory.createLeaf(
          this.formatHeaderForHexData(
            ...
            signature.signature,
            errorFieldSet.has('signatureSig' /* Protocol.Network.SignedExchangeErrorField.SignatureSig */),
          ),
        );
        if (signature.certUrl) {
          const certURLElement = this.formatHeader(
            ...
            signature.certUrl,
            errorFieldSet.has('signatureCertUrl' /* Protocol.Network.SignedExchangeErrorField.SignatureCertUrl */),
          );
        ...
        signatureCategory.createLeaf(
          this.formatHeader(
            ...
            signature.integrity,
            errorFieldSet.has('signatureIntegrity' /* Protocol.Network.SignedExchangeErrorField.SignatureIntegrity */),
          ),
        );
        ...
        signatureCategory.createLeaf().title = this.formatHeader(
          ...
          errorFieldSet.has('signatureTimestamps' /* Protocol.Network.SignedExchangeErrorField.SignatureTimestamps */),
        );
        signatureCategory.createLeaf().title = this.formatHeader(
