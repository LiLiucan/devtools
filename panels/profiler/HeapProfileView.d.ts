...
declare const SamplingHeapProfileTypeBase_base: (new (...args: any[]) => {
   ...
   */;
  addEventListener<T extends keyof SamplingHeapProfileType.EventTypes>(
    eventType: T,
    listener: (arg0: Common.EventTarget.EventTargetEvent<SamplingHeapProfileType.EventTypes[T]>) => void,
    thisObject?: Object | undefined,
  ): Common.EventTarget.EventDescriptor<SamplingHeapProfileType.EventTypes, T>;
  once<T_1 extends keyof SamplingHeapProfileType.EventTypes>(
    eventType: T_1,
  ): Promise<SamplingHeapProfileType.EventTypes[T_1]>;
  removeEventListener<T_2 extends keyof SamplingHeapProfileType.EventTypes>(
    eventType: T_2,
    listener: (arg0: Common.EventTarget.EventTargetEvent<SamplingHeapProfileType.EventTypes[T_2]>) => void,
    thisObject?: Object | undefined,
  ): void;
  hasEventListeners(eventType: keyof SamplingHeapProfileType.EventTypes): boolean;
  dispatchEventToListeners<T_3 extends keyof SamplingHeapProfileType.EventTypes>(
    eventType: Platform.TypeScriptUtilities.NoUnion<T_3>,
    ...eventData: Common.EventTarget.EventPayloadToRestParameters<SamplingHeapProfileType.EventTypes, T_3>
  ): void;
}) &
  typeof ProfileType;
...
export declare class HeapFlameChartDataProvider extends ProfileFlameChartDataProvider {
  ...
  constructor(
    profile: SDK.ProfileTreeModel.ProfileTreeModel,
    heapProfilerModel: SDK.HeapProfilerModel.HeapProfilerModel | null,
  );
