...
declare const HeapSnapshotGridNode_base: (new (...args: any[]) => {
  ...
  addEventListener<T extends HeapSnapshotGridNode.Events.PopulateComplete>(
    eventType: T,
    listener: (arg0: Common.EventTarget.EventTargetEvent<HeapSnapshotGridNode.EventTypes[T]>) => void,
    thisObject?: Object | undefined,
  ): Common.EventTarget.EventDescriptor<HeapSnapshotGridNode.EventTypes, T>;
  once<T_1 extends HeapSnapshotGridNode.Events.PopulateComplete>(
    eventType: T_1,
  ): Promise<HeapSnapshotGridNode.EventTypes[T_1]>;
  removeEventListener<T_2 extends HeapSnapshotGridNode.Events.PopulateComplete>(
    eventType: T_2,
    listener: (arg0: Common.EventTarget.EventTargetEvent<HeapSnapshotGridNode.EventTypes[T_2]>) => void,
    thisObject?: Object | undefined,
  ): void;
  hasEventListeners(eventType: HeapSnapshotGridNode.Events.PopulateComplete): boolean;
  dispatchEventToListeners<T_3 extends HeapSnapshotGridNode.Events.PopulateComplete>(
    eventType: Platform.TypeScriptUtilities.NoUnion<T_3>,
    ...eventData: Common.EventTarget.EventPayloadToRestParameters<HeapSnapshotGridNode.EventTypes, T_3>
  ): void;
}) &
...
export declare class HeapSnapshotGridNode extends HeapSnapshotGridNode_base {
  ...
  getHash(): number;
  createChildNode(
    _item: HeapSnapshotModel.HeapSnapshotModel.Node | HeapSnapshotModel.HeapSnapshotModel.Edge,
  ...
  dispose(): void;
  queryObjectContent(
    _heapProfilerModel: SDK.HeapProfilerModel.HeapProfilerModel,
  ...
  populateContextMenu(
    _contextMenu: UI.ContextMenu.ContextMenu,
  ...
  childHashForEntity(
    entity: HeapSnapshotModel.HeapSnapshotModel.Node | HeapSnapshotModel.HeapSnapshotModel.Edge,
  ): number;
...
export declare class HeapSnapshotObjectNode extends HeapSnapshotGenericObjectNode {
  ...
  constructor(
    ...
    snapshot: HeapSnapshotProxy,
    edge: HeapSnapshotModel.HeapSnapshotModel.Edge,
    parentObjectNode: HeapSnapshotObjectNode | null,
  );
  retainersDataSource(): {
    snapshot: HeapSnapshotProxy;
...
export declare class HeapSnapshotRetainingObjectNode extends HeapSnapshotObjectNode {
  constructor(
    ...
    snapshot: HeapSnapshotProxy,
    edge: HeapSnapshotModel.HeapSnapshotModel.Edge,
    parentRetainingObjectNode: HeapSnapshotRetainingObjectNode | null,
  );
  createProvider(): HeapSnapshotProviderProxy;
  createChildNode(
    item: HeapSnapshotModel.HeapSnapshotModel.Node | HeapSnapshotModel.HeapSnapshotModel.Edge,
...
export declare class HeapSnapshotInstanceNode extends HeapSnapshotGenericObjectNode {
  ...
  constructor(
    dataGrid: HeapSnapshotSortableDataGrid,
    snapshot: HeapSnapshotProxy,
    node: HeapSnapshotModel.HeapSnapshotModel.Node,
...
export declare class HeapSnapshotConstructorNode extends HeapSnapshotGridNode {
  ...
  constructor(
    dataGrid: HeapSnapshotConstructorsDataGrid,
    className: string,
