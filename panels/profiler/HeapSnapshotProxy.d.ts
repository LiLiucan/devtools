...
export declare class HeapSnapshotWorkerProxy extends Common.ObjectWrapper
  .ObjectWrapper<HeapSnapshotWorkerProxy.EventTypes> {
  ...
  callFactoryMethod<T>(
    callback: ((...arg0: unknown[]) => void) | null,
    objectId: string,
    methodName: string,
    proxyConstructor: new (...arg1: unknown[]) => T,
  ): Object | null;
...
export declare class HeapSnapshotProxyObject {
  ...
  disposeWorker(): void;
  callFactoryMethod<T>(
    _callback: ((...arg0: any[]) => void) | null,
    _methodName: string,
    _proxyConstructor: new (...arg1: any[]) => T,
    ..._var_args: any[]
  ): T;
  callMethodPromise<T>(_methodName: string, ..._var_args: any[]): Promise<T>;
}
export declare class HeapSnapshotLoaderProxy
  extends HeapSnapshotProxyObject
...
export declare class HeapSnapshotProxy extends HeapSnapshotProxyObject {
  ...
  search(
    ...
    filter: HeapSnapshotModel.HeapSnapshotModel.NodeFilter,
  ): Promise<number[]>;
