...
export declare class HeapSnapshotView
  extends UI.View.SimpleView
  implements DataDisplayDelegate, UI.SearchableView.Searchable
{
  ...
  selectionChanged(
    event: Common.EventTarget.EventTargetEvent<DataGrid.DataGrid.DataGridNode<HeapSnapshotGridNode>>,
  ): void;
...
declare const HeapSnapshotProfileType_base: (new (...args: any[]) => {
  ...
  addEventListener<T extends HeapSnapshotProfileTypeEvents.SnapshotReceived>(
    eventType: T,
    listener: (arg0: Common.EventTarget.EventTargetEvent<HeapSnapshotProfileTypeEventTypes[T]>) => void,
    thisObject?: Object | undefined,
  ): Common.EventTarget.EventDescriptor<HeapSnapshotProfileTypeEventTypes, T>;
  once<T_1 extends HeapSnapshotProfileTypeEvents.SnapshotReceived>(
    eventType: T_1,
  ): Promise<HeapSnapshotProfileTypeEventTypes[T_1]>;
  removeEventListener<T_2 extends HeapSnapshotProfileTypeEvents.SnapshotReceived>(
    eventType: T_2,
    listener: (arg0: Common.EventTarget.EventTargetEvent<HeapSnapshotProfileTypeEventTypes[T_2]>) => void,
    thisObject?: Object | undefined,
  ): void;
  hasEventListeners(eventType: HeapSnapshotProfileTypeEvents.SnapshotReceived): boolean;
  dispatchEventToListeners<T_3 extends HeapSnapshotProfileTypeEvents.SnapshotReceived>(
    eventType: Platform.TypeScriptUtilities.NoUnion<T_3>,
    ...eventData: Common.EventTarget.EventPayloadToRestParameters<HeapSnapshotProfileTypeEventTypes, T_3>
  ): void;
}) &
  typeof ProfileType;
export declare class HeapSnapshotProfileType
  extends HeapSnapshotProfileType_base
  implements SDK.TargetManager.SDKModelObserver<SDK.HeapProfilerModel.HeapProfilerModel>
{
  ...
  reportHeapSnapshotProgress(
    event: Common.EventTarget.EventTargetEvent<SDK.HeapProfilerModel.HeapSnapshotProgress>,
  ): void;
...
declare const TrackingHeapSnapshotProfileType_base: (new (...args: any[]) => {
  ...
  addEventListener<T extends keyof TrackingHeapSnapshotProfileTypeEventTypes>(
    eventType: T,
    listener: (arg0: Common.EventTarget.EventTargetEvent<TrackingHeapSnapshotProfileTypeEventTypes[T]>) => void,
    thisObject?: Object | undefined,
  ): Common.EventTarget.EventDescriptor<TrackingHeapSnapshotProfileTypeEventTypes, T>;
  once<T_1 extends keyof TrackingHeapSnapshotProfileTypeEventTypes>(
    eventType: T_1,
  ): Promise<TrackingHeapSnapshotProfileTypeEventTypes[T_1]>;
  removeEventListener<T_2 extends keyof TrackingHeapSnapshotProfileTypeEventTypes>(
    eventType: T_2,
    listener: (arg0: Common.EventTarget.EventTargetEvent<TrackingHeapSnapshotProfileTypeEventTypes[T_2]>) => void,
    thisObject?: Object | undefined,
  ): void;
  hasEventListeners(eventType: keyof TrackingHeapSnapshotProfileTypeEventTypes): boolean;
  dispatchEventToListeners<T_3 extends keyof TrackingHeapSnapshotProfileTypeEventTypes>(
    eventType: Platform.TypeScriptUtilities.NoUnion<T_3>,
    ...eventData: Common.EventTarget.EventPayloadToRestParameters<TrackingHeapSnapshotProfileTypeEventTypes, T_3>
  ): void;
}) &
