...
declare const HeapTimelineOverview_base: (new (...args: any[]) => {
  ...
  addEventListener<T extends Events.IdsRangeChanged>(
    eventType: T,
  ...
  removeEventListener<T_2 extends Events.IdsRangeChanged>(
    eventType: T_2,
  ...
  dispatchEventToListeners<T_3 extends Events.IdsRangeChanged>(
