...
declare const ProfileLauncherView_base: (new (...args: any[]) => {
  ...
  addEventListener<T extends Events.ProfileTypeSelected>(
    eventType: T,
  ...
  removeEventListener<T_2 extends Events.ProfileTypeSelected>(
    eventType: T_2,
  ...
  dispatchEventToListeners<T_3 extends Events.ProfileTypeSelected>(
...
export declare class ProfileLauncherView extends ProfileLauncherView_base {
  ...
  typeIdToOptionElementAndProfileType: Map<
    string,
    {
