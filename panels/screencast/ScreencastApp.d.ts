...
export declare class ScreencastApp
  implements Common.App.App, SDK.TargetManager.SDKModelObserver<SDK.ScreenCaptureModel.ScreenCaptureModel>
{
...
export declare class ToolbarButtonProvider implements UI.Toolbar.Provider {
  static instance(opts?: { forceNew: boolean }): ToolbarButtonProvider;
  item(): UI.Toolbar.ToolbarItem | null;
}
export declare class ScreencastAppProvider implements Common.AppProvider.AppProvider {
  static instance(opts?: { forceNew: boolean }): ScreencastAppProvider;
