...
export declare class SecurityModel extends SDK.SDKModel.SDKModel<EventTypes> {
  ...
  static SecurityStateComparator(
    a: Protocol.Security.SecurityState | null,
    b: Protocol.Security.SecurityState | null,
  ): number;
}
...
export declare class PageVisibleSecurityState {
  ...
  constructor(
    ...
    safetyTipInfo: Protocol.Security.SafetyTipInfo | null,
    securityStateIssueIds: string[],
  );
}
...
export declare class SecurityStyleExplanation {
  ...
  constructor(
    ...
    mixedContentType?: Protocol.Security.MixedContentType | undefined,
