...
export declare class SecurityPanel
  extends UI.Panel.PanelWithSidebar
  implements SDK.TargetManager.SDKModelObserver<SecurityModel>
{
  ...
  private constructor();
  static instance(opts?: { forceNew: boolean | null }): SecurityPanel;
