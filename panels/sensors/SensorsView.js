...
export class SensorsView extends UI.Widget.VBox {
  ...
  createLocationSection(location) {
    ...
    const manageButton = UI.UIUtils.createTextButton(i18nString(UIStrings.manage), () =>
      Common.Revealer.reveal(customLocations),
    );
  ...
  orientationSelectChanged() {
    ...
    if (value === NonPresetOptions.NoOverride) {
      ...
      this.setDeviceOrientation(
        ...
        'selectPreset' /* DeviceOrientationModificationSource.SelectPreset */,
      );
    }
  }
  ...
  applyDeviceOrientationUserInput() {
    this.setDeviceOrientation(
      ...
      'userInput' /* DeviceOrientationModificationSource.UserInput */,
    );
  ...
  resetDeviceOrientation() {
    this.setDeviceOrientation(
      ...
      'resetButton' /* DeviceOrientationModificationSource.ResetButton */,
    );
