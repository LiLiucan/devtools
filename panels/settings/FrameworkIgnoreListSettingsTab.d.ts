...
export declare class FrameworkIgnoreListSettingsTab
  ...
  implements UI.ListWidget.Delegate<Common.Settings.RegExpSettingItem>
{
  ...
  commitEdit(
    item: Common.Settings.RegExpSettingItem,
    editor: UI.ListWidget.Editor<Common.Settings.RegExpSettingItem>,
    isNew: boolean,
  ): void;
