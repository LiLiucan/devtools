...
export class FrameworkIgnoreListSettingsTab extends UI.Widget.VBox {
  ...
  constructor() {
    ...
    ignoreListOptions.createChild('div', 'ignore-list-option-group').textContent = i18nString(
      UIStrings.generalExclusionRules,
    );
    const ignoreListContentScripts = ignoreListOptions.createChild('div', 'ignore-list-option');
    ignoreListContentScripts.appendChild(
    ...
    automaticallyIgnoreList.appendChild(
      UI.SettingsUI.createSettingCheckbox(
        i18nString(UIStrings.automaticallyIgnoreListKnownThirdPartyScripts),
        Common.Settings.Settings.instance().moduleSetting('automaticallyIgnoreListKnownThirdPartyScripts'),
        true,
      ),
    );
    UI.Tooltip.Tooltip.install(
      automaticallyIgnoreList,
      i18nString(UIStrings.automaticallyIgnoreListKnownThirdPartyScriptsTooltip),
    );
    ignoreListOptions.createChild('div', 'ignore-list-option-group').textContent = i18nString(
      UIStrings.customExclusionRules,
    );
