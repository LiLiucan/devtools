...
export declare class DevicesSettingsTab
  extends UI.Widget.VBox
  implements UI.ListWidget.Delegate<EmulationModel.EmulatedDevices.EmulatedDevice>
{
  ...
  commitEdit(
    ...
    editor: UI.ListWidget.Editor<EmulationModel.EmulatedDevices.EmulatedDevice>,
    isNew: boolean,
  ): void;
  beginEdit(
    device: EmulationModel.EmulatedDevices.EmulatedDevice,
