...
export declare class CallStackSidebarPane
  extends UI.View.SimpleView
  implements UI.ContextFlavorListener.ContextFlavorListener, UI.ListControl.ListDelegate<Item>
{
  ...
  private constructor();
  static instance(opts?: { forceNew: boolean | null }): CallStackSidebarPane;
...
export declare class Item {
  ...
  static createForDebuggerCallFrame(
    frame: SDK.DebuggerModel.CallFrame,
    locationPool: Bindings.LiveLocation.LiveLocationPool,
    updateDelegate: (arg0: Item) => void,
  ): Promise<Item>;
  static createItemsForAsyncStack(
    title: string,
