...
export declare class JavaScriptBreakpointsSidebarPane
  extends UI.ThrottledWidget.ThrottledWidget
  implements UI.ContextFlavorListener.ContextFlavorListener, UI.ListControl.ListDelegate<BreakpointItem>
{
  ...
  selectedItemChanged(
    _from: BreakpointItem | null,
    _to: BreakpointItem | null,
