...
export declare class NavigatorView extends UI.Widget.VBox implements SDK.TargetManager.Observer {
  ...
  revealUISourceCode(
    ...
    select?: boolean,
  ): NavigatorUISourceCodeTreeNode | null;
  ...
  create(
    ...
    path: Platform.DevToolsPath.EncodedPathString,
    uiSourceCodeToCopy?: Workspace.UISourceCode.UISourceCode,
  ): Promise<void>;
...
export declare class NavigatorFolderTreeNode extends NavigatorTreeNode {
  ...
  constructor(
    ...
    id: string,
    type: string,
    folderPath: Platform.DevToolsPath.EncodedPathString,
    title: string,
  );
  treeNode(): UI.TreeOutline.TreeElement;
  updateTitle(): void;
