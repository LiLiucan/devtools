  ...
  do {
    switch (cursor.name) {
      ...
      case 'MethodDeclaration': {
        ...
        cursor.firstChild();
        do {
          if (cursor.name === 'async' || cursor.name === 'get' || cursor.name === 'set' || cursor.name === 'static') {
            prefix = `${prefix}${cursor.name} `;
          } else if (cursor.name === 'Star') {
            prefix += '*';
          } else if (cursor.name === 'PropertyDefinition' || cursor.name === 'VariableDefinition') {
        ...
        if (cursor.matchContext(['ClassDeclaration'])) {
          ...
          do {
            if (cursor.name === 'ArrowFunction' || cursor.name === 'FunctionExpression') {
              ...
              items.push({ title, lineNumber, columnNumber });
              break;
            } else if (cursor.name === 'ObjectExpression' || cursor.name === 'VariableDefinition') {
              cursor.prevSibling();
              break;
            }
          } while (cursor.nextSibling());
