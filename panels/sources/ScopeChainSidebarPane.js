...
export class ScopeChainSidebarPane extends UI.Widget.VBox {
  ...
  setScopeSourceMapSubscription(callFrame) {
    ...
    if (oldScript) {
      oldScript.debuggerModel
        .sourceMapManager()
        .removeEventListener(SDK.SourceMapManager.Events.SourceMapAttached, this.sourceMapAttached, this);
    }
    if (this.#scopesScript) {
      this.#scopesScript.debuggerModel
        .sourceMapManager()
        .addEventListener(SDK.SourceMapManager.Events.SourceMapAttached, this.sourceMapAttached, this);
    }
  }
  ...
  createScopeSectionTreeElement(scope, extraProperties) {
    ...
    const section = new ObjectUI.ObjectPropertiesSection.RootElement(
      ...
      this.linkifier,
      emptyPlaceholder,
      0 /* ObjectUI.ObjectPropertiesSection.ObjectPropertiesMode.All */,
      extraProperties,
    );
