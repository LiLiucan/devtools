...
export declare class NetworkNavigatorView extends NavigatorView {
  private constructor();
  wasShown(): void;
  static instance(opts?: { forceNew: boolean | null }): NetworkNavigatorView;
...
export declare class OverridesNavigatorView extends NavigatorView {
  ...
  private constructor();
  static instance(opts?: { forceNew: boolean | null }): OverridesNavigatorView;
...
export declare class ContentScriptsNavigatorView extends NavigatorView {
  private constructor();
  static instance(opts?: { forceNew: boolean | null }): ContentScriptsNavigatorView;
  acceptProject(project: Workspace.Workspace.Project): boolean;
}
