...
export declare class SourcesPanel
  extends UI.Panel.Panel
  implements UI.ContextMenu.Provider, SDK.TargetManager.Observer, UI.View.ViewLocationResolver
{
...
export declare class UILocationRevealer implements Common.Revealer.Revealer {
  static instance(opts?: { forceNew: boolean | null }): UILocationRevealer;
...
export declare class DebuggerLocationRevealer implements Common.Revealer.Revealer {
  static instance(opts?: { forceNew: boolean | null }): DebuggerLocationRevealer;
...
export declare class UISourceCodeRevealer implements Common.Revealer.Revealer {
  static instance(opts?: { forceNew: boolean | null }): UISourceCodeRevealer;
...
export declare class DebuggerPausedDetailsRevealer implements Common.Revealer.Revealer {
  static instance(opts?: { forceNew: boolean | null }): DebuggerPausedDetailsRevealer;
...
export declare class RevealingActionDelegate implements UI.ActionRegistration.ActionDelegate {
  static instance(opts?: { forceNew: boolean | null }): RevealingActionDelegate;
  handleAction(context: UI.Context.Context, actionId: string): boolean;
}
export declare class ActionDelegate implements UI.ActionRegistration.ActionDelegate {
  static instance(opts?: { forceNew: boolean | null }): ActionDelegate;
  handleAction(context: UI.Context.Context, actionId: string): boolean;
}
