...
declare const UISourceCodeFrame_base: (new (...args: any[]) => {
  ...
  addEventListener<T extends Events.ToolbarItemsChanged>(
    eventType: T,
  ...
  removeEventListener<T_2 extends Events.ToolbarItemsChanged>(
    eventType: T_2,
  ...
  dispatchEventToListeners<T_3 extends Events.ToolbarItemsChanged>(
