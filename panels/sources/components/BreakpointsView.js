...
export class BreakpointsView extends HTMLElement {
  ...
  #render() {
    ...
    <div class='pause-on-exceptions'>
      <label class='checkbox-label'>
        <input type='checkbox' ?checked=${this.#pauseOnExceptions} @change=${this.#onPauseOnExceptionsStateChanged.bind(
      this,
    )}>
      ...
      <div class='pause-on-caught-exceptions'>
        <label class='checkbox-label'>
          <input type='checkbox' ?checked=${
            this.#pauseOnCaughtExceptions
          } @change=${this.#onPauseOnCaughtExceptionsStateChanged.bind(this)}>
  ...
  #renderEditBreakpointButton(breakpointItem) {
    ...
    const title =
      breakpointItem.type === 'LOGPOINT' /* BreakpointType.LOGPOINT */
    ...
    return LitHtml.html`
      <details class=${LitHtml.Directives.classMap(classMap)}
        ...
        <summary @contextmenu=${contextmenuHandler} >
          <span class='group-header' aria-hidden=true>${this.#renderFileIcon()}<span class='group-header-title' title='${
      group.url
  ...
  #onBreakpointEntryContextMenu(event, breakpointItem, editable) {
    ...
    const otherItems = this.#breakpointGroups
  ...
  #renderBreakpointEntry(breakpointItem, editable) {
    ...
    const classMap = {
      ...
      'conditional-breakpoint':
        breakpointItem.type === 'CONDITIONAL_BREAKPOINT' /* BreakpointType.CONDITIONAL_BREAKPOINT */,
    ...
    <div class=${LitHtml.Directives.classMap(classMap)}
      ...
      <label class='checkbox-label'>
        ...
        <input type='checkbox' aria-label=${breakpointItem.location} ?indeterminate=${
      breakpointItem.status === 'INDETERMINATE' /* BreakpointStatus.INDETERMINATE */
    } ?checked=${breakpointItem.status === 'ENABLED' /* BreakpointStatus.ENABLED */} @change=${(e) =>
      this.#onCheckboxToggled(e, breakpointItem)}>
      </label>
