...
declare type TimelineFlameChartEntry =
  | SDK.FilmStripModel.Frame
  | SDK.TracingModel.Event
  | TimelineModel.TimelineFrameModel.TimelineFrame;
export declare class TimelineFlameChartDataProvider
  ...
  implements PerfUI.FlameChart.FlameChartDataProvider
{
  ...
  appendExtensionEvents(entry: { title: string; model: SDK.TracingModel.TracingModel }): void;
