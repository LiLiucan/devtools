...
export declare class TimelineTreeView extends UI.Widget.VBox implements UI.SearchableView.Searchable {
  ...
  buildTopDownTree(
    ...
    groupIdCallback: ((arg0: SDK.TracingModel.Event) => string) | null,
...
declare const TimelineStackView_base: (new (...args: any[]) => {
  ...
  addEventListener<T extends TimelineStackView.Events.SelectionChanged>(
    eventType: T,
    listener: (arg0: Common.EventTarget.EventTargetEvent<TimelineStackView.EventTypes[T]>) => void,
    thisObject?: Object | undefined,
  ): Common.EventTarget.EventDescriptor<TimelineStackView.EventTypes, T>;
  once<T_1 extends TimelineStackView.Events.SelectionChanged>(
    eventType: T_1,
  ): Promise<TimelineStackView.EventTypes[T_1]>;
  removeEventListener<T_2 extends TimelineStackView.Events.SelectionChanged>(
    eventType: T_2,
    listener: (arg0: Common.EventTarget.EventTargetEvent<TimelineStackView.EventTypes[T_2]>) => void,
    thisObject?: Object | undefined,
  ): void;
  hasEventListeners(eventType: TimelineStackView.Events.SelectionChanged): boolean;
  dispatchEventToListeners<T_3 extends TimelineStackView.Events.SelectionChanged>(
    eventType: Platform.TypeScriptUtilities.NoUnion<T_3>,
    ...eventData: Common.EventTarget.EventPayloadToRestParameters<TimelineStackView.EventTypes, T_3>
  ): void;
}) &
