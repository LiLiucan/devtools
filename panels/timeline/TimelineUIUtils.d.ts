...
export declare class TimelineUIUtils {
  ...
  static buildNetworkRequestDetails(
    request: TimelineModel.TimelineModel.NetworkRequest,
    model: TimelineModel.TimelineModel.TimelineModelImpl,
    linkifier: Components.Linkifier.Linkifier,
  ): Promise<DocumentFragment>;
  ...
  static setCategories(cats: { [x: string]: TimelineCategory }): void;
