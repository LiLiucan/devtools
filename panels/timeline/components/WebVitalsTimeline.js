...
export class WebVitalsTimeline extends HTMLElement {
  ...
  constructor() {
    ...
    this.#fcpLane = new WebVitalsEventLane(
      this,
      i18nString(UIStrings.fcp),
      (e) => this.#getMarkerTypeForFCPEvent(e),
      this.#getFCPMarkerOverlay,
    );
    this.#lcpLane = new WebVitalsEventLane(
      this,
      i18nString(UIStrings.lcp),
      (e) => this.#getMarkerTypeForLCPEvent(e),
      this.#getLCPMarkerOverlay,
    );
