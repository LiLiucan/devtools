...
export declare class AudioContextSelector
  ...
  implements UI.SoftDropDown.Delegate<Protocol.WebAudio.BaseAudioContext>
{
  ...
  contextChanged({
    data: changedContext,
  }: Common.EventTarget.EventTargetEvent<Protocol.WebAudio.BaseAudioContext>): void;
  ...
  highlightedItemChanged(
    from: Protocol.WebAudio.BaseAudioContext | null,
    to: Protocol.WebAudio.BaseAudioContext | null,
