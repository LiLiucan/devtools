...
export class WebAudioView extends UI.ThrottledWidget.ThrottledWidget {
  ...
  addEventListeners(webAudioModel) {
    ...
    webAudioModel.addEventListener(
      'AudioListenerCreated' /* ModelEvents.AudioListenerCreated */,
      this.audioListenerCreated,
      this,
    );
    webAudioModel.addEventListener(
      'AudioListenerWillBeDestroyed' /* ModelEvents.AudioListenerWillBeDestroyed */,
      this.audioListenerWillBeDestroyed,
      this,
    );
    webAudioModel.addEventListener('AudioNodeCreated' /* ModelEvents.AudioNodeCreated */, this.audioNodeCreated, this);
    webAudioModel.addEventListener(
      'AudioNodeWillBeDestroyed' /* ModelEvents.AudioNodeWillBeDestroyed */,
      this.audioNodeWillBeDestroyed,
      this,
    );
    webAudioModel.addEventListener(
      'AudioParamCreated' /* ModelEvents.AudioParamCreated */,
      this.audioParamCreated,
      this,
    );
    webAudioModel.addEventListener(
      'AudioParamWillBeDestroyed' /* ModelEvents.AudioParamWillBeDestroyed */,
    ...
    webAudioModel.addEventListener(
      'NodesDisconnected' /* ModelEvents.NodesDisconnected */,
      this.nodesDisconnected,
      this,
    );
    webAudioModel.addEventListener(
      'NodeParamConnected' /* ModelEvents.NodeParamConnected */,
      this.nodeParamConnected,
      this,
    );
    webAudioModel.addEventListener(
      'NodeParamDisconnected' /* ModelEvents.NodeParamDisconnected */,
      this.nodeParamDisconnected,
      this,
    );
  }
  removeEventListeners(webAudioModel) {
    ...
    webAudioModel.removeEventListener(
      'ContextDestroyed' /* ModelEvents.ContextDestroyed */,
    ...
    webAudioModel.removeEventListener(
      'AudioNodeCreated' /* ModelEvents.AudioNodeCreated */,
      this.audioNodeCreated,
      this,
    );
    webAudioModel.removeEventListener(
      'AudioNodeWillBeDestroyed' /* ModelEvents.AudioNodeWillBeDestroyed */,
