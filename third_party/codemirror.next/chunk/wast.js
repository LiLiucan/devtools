import { a as e, i as c, d as O, b as r, e as o, s as n, t as Q, g as t, L as $ } from './codemirror.js';
const s = {
    __proto__: null,
    anyref: 34,
    dataref: 34,
  ...
  P = e.define({
    parser: a.configure({
      props: [
        c.add({ App: O({ closing: ')', align: !1 }) }),
        r.add({ App: o, BlockComment: (e) => ({ from: e.from + 2, to: e.to - 2 }) }),
        n({
          Keyword: Q.keyword,
          Type: Q.typeName,
          Number: Q.number,
...
export { i as wast, P as wastLanguage };
