...
*/
declare type StateCommand = (target: { state: EditorState; dispatch: (transaction: Transaction) => void }) => boolean;
...
declare class EditorView {
  ...
  static inputHandler: Facet<
    ...
    readonly ((view: EditorView, from: number, to: number, text: string) => boolean)[]
  >;
  /**
...
*/
declare function syntaxHighlighting(
...
declare namespace _codemirror_lang_python {
  export { python$1 as python, _codemirror_lang_python_pythonLanguage as pythonLanguage };
}
...
completion.
*/
declare function javascript(config?: { jsx?: boolean; typescript?: boolean }): LanguageSupport;
/**
