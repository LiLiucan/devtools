...
export class LocalizedStringSet {
  ...
  getMessageFormatterFor(message) {
    ...
    return new IntlMessageFormat.IntlMessageFormat(messageToTranslate, this.localeForFormatter, undefined, {
      ignoreTag: true,
    });
  }
  ...
  getFormattedLocalizedString(message, values) {
    ...
    try {
      ...
      const formatter = new IntlMessageFormat.IntlMessageFormat(message, this.localeForFormatter, undefined, {
        ignoreTag: true,
      });
      return formatter.format(values);
    }
