...
export class DOM {
   ...
   * @return {HTMLElementByTagName[T]}
   */
  createChildOf<T_1 extends string>(
    parentElem: Element,
    elementName: T_1,
...
export class ReportRenderer {
   ...
   */
  _renderScoreGauges(
    report: LH.ReportResult,
    categoryRenderer: CategoryRenderer,
    specificCategoryRenderers: Record<string, CategoryRenderer>,
  ): DocumentFragment[];
  /**
   * @param {LH.ReportResult} report
   * @return {!DocumentFragment}
...
export class ReportUIFeatures {
   ...
   */
  addButton(opts: { text: string; icon?: string; onClick: () => void }): HTMLElementByTagName;
  resetUIState(): void;
  /**
...
declare class CategoryRenderer {
   ...
   */
  renderClump(
    clumpId: Exclude<TopLevelClumpId, 'failed'>,
    {
      auditRefs,
      description,
    }: {
 ...
 */
declare function registerLocaleData(
  locale: LH.Locale,
  lhlMessages: Record<
    string,
    {
...
declare class DetailsRenderer {
   ...
   * @return {Element}
   */
  _renderBytes(details: { value: number; granularity?: number }): Element;
  /**
   * @param {{value: number, granularity?: number, displayUnit?: string}} details
   * @return {Element}
   */
  _renderMilliseconds(details: { value: number; granularity?: number; displayUnit?: string }): Element;
  /**
   * @param {string} text
   * @return {HTMLElement}
   */
   ...
   * @return {HTMLElement}
   */
  _renderLink(details: { text: string; url: string }): HTMLElement;
  /**
   * @param {string} text
   ...
   * @return {Element}
   */
  _renderNumeric(details: { value: number; granularity?: number }): Element;
  /**
  ...
  _getCanonicalizedsubItemsHeading(
    subItemsHeading: Exclude<LH.Audit.Details.TableColumnHeading['subItemsHeading'], undefined>,
    parentHeading: LH.Audit.Details.TableColumnHeading,
  ): LH.Audit.Details.OpportunityColumnHeading;
  /**
   ...
   */
  _getDerivedsubItemsHeading(
    heading: LH.Audit.Details.OpportunityColumnHeading,
  ): LH.Audit.Details.OpportunityColumnHeading | null;
  /**
  ...
  _renderTableRow(
    item: TableItem,
    headings: (LH.Audit.Details.OpportunityColumnHeading | null)[],
  ): HTMLElementByTagName;
  /**
