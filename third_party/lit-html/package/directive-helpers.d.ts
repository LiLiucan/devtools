 ...
 */
export declare const insertPart: (
  containerPart: import('./lit-html.js').ChildPart,
  refPart?: import('./lit-html.js').ChildPart | undefined,
  part?: import('./lit-html.js').ChildPart | undefined,
) => import('./lit-html.js').ChildPart;
/**
 ...
 */
export declare const setChildPartValue: <T extends import('./lit-html.js').ChildPart>(
  part: T,
  value: unknown,
