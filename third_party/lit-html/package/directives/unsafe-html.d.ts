...
export declare class UnsafeHTMLDirective extends Directive {
  ...
  ): typeof noChange | typeof nothing | TemplateResult<1 | 2> | null | undefined;
}
/**
 ...
 * vulnerabilities.
 */
export declare const unsafeHTML: (
  value: string | typeof noChange | typeof nothing | null | undefined,
) => import('../directive.js').DirectiveResult<typeof UnsafeHTMLDirective>;
