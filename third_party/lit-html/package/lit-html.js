        ...
        ($ = d.lastIndex),
          d === c
            ...
            ? '>' === u[0]
              ...
              : void 0 === u[1]
              ? (p = -2)
              : ((p = d.lastIndex - u[2].length), (o = u[1]), (d = void 0 === u[3] ? f : '"' === u[3] ? m : _))
            : d === m || d === _
            ? (d = f)
            : d === v || d === a
            ? (d = c)
      ...
      if (1 === l.nodeType) {
        ...
        if (g.test(l.tagName)) {
          ...
          if (s > 0) {
            ...
            for (let i = 0; i < s; i++) l.append(t[i], h()), A.nextNode(), c.push({ type: 2, index: ++r });
            l.append(t[s], h());
          }
        }
        ...
        if (l.data === o) c.push({ type: 2, index: r });
          ...
          let t = -1;
          for (; -1 !== (t = l.data.indexOf(e, t + 1)); ) c.push({ type: 7, index: r }), (t += e.length - 1);
        }
      r++;
    }
  }
...
function P(t, i, s = t, e) {
  ...
  return (
    (null == d ? void 0 : d.constructor) !== u &&
      (null === (n = null == d ? void 0 : d._$AO) || void 0 === n || n.call(d, !1),
      void 0 === u ? (d = void 0) : ((d = new u(t)), d._$AT(t, s, e)),
      void 0 !== e ? ((null !== (l = (h = s)._$Cl) && void 0 !== l ? l : (h._$Cl = []))[e] = d) : (s._$Cu = d)),
...
class N {
  constructor(t, i, s, e) {
    ...
    (this.type = 2),
      ...
      (this._$AM = s),
      (this.options = e),
      (this._$Cg = null === (o = null == e ? void 0 : e.isConnected) || void 0 === o || o);
  }
  get _$AU() {
    var t, i;
  ...
  S(t) {
    ...
    let s,
      e = 0;
    for (const o of t)
      e === i.length ? i.push((s = new N(this.A(h()), this.A(h()), this, this.options))) : (s = i[e]), s._$AI(o), e++;
...
const R = { P: '$lit$', L: e, V: o, I: 1, N: C, R: V, D: u, j: P, H: N, O: S, F: H, B: I, W: M, Z: L },
