...
export class Accessibility {
  ...
  async snapshot(options = {}) {
    ...
    const { nodes } = await __classPrivateFieldGet(this, _Accessibility_client, 'f').send(
...
class AXNode {
  ...
  isLeafNode() {
    ...
    // any children.
    if (
      __classPrivateFieldGet(this, _AXNode_instances, 'm', _AXNode_isPlainTextField).call(this) ||
      __classPrivateFieldGet(this, _AXNode_instances, 'm', _AXNode_isTextOnlyObject).call(this)
    ) {
      return true;
    }
  ...
  isInteresting(insideControl) {
    ...
    if (
      role === 'Ignored' ||
      __classPrivateFieldGet(this, _AXNode_hidden, 'f') ||
...
(_AXNode_richlyEditable = new WeakMap()),
  ...
  (_AXNode_isPlainTextField = function _AXNode_isPlainTextField() {
    ...
    return (
      __classPrivateFieldGet(this, _AXNode_role, 'f') === 'textbox' ||
    ...
    if (__classPrivateFieldGet(this, _AXNode_cachedHasFocusableChild, 'f') === undefined) {
      ...
      for (const child of this.children) {
        if (
          ...
          __classPrivateFieldGet(child, _AXNode_instances, 'm', _AXNode_hasFocusableChild).call(child)
        ) {
