...
export class CDPBrowser extends BrowserBase {
  ...
  constructor(
    ...
    _CDPBrowser_createTarget.set(this, (targetInfo, session) => {
      ...
      const context =
        browserContextId && __classPrivateFieldGet(this, _CDPBrowser_contexts, 'f').has(browserContextId)
      ...
      return new Target(
        ...
        session,
        context,
        __classPrivateFieldGet(this, _CDPBrowser_targetManager, 'f'),
        (isAutoAttachEmulated) => {
          return __classPrivateFieldGet(this, _CDPBrowser_connection, 'f')._createSession(
            targetInfo,
            isAutoAttachEmulated,
          );
        },
        __classPrivateFieldGet(this, _CDPBrowser_ignoreHTTPSErrors, 'f'),
        (_a = __classPrivateFieldGet(this, _CDPBrowser_defaultViewport, 'f')) !== null && _a !== void 0 ? _a : null,
        __classPrivateFieldGet(this, _CDPBrowser_screenshotTaskQueue, 'f'),
        __classPrivateFieldGet(this, _CDPBrowser_isPageTargetCallback, 'f'),
      );
    });
    ...
    __classPrivateFieldGet(this, _CDPBrowser_instances, 'm', _CDPBrowser_setIsPageTargetCallback).call(
      this,
      isPageTargetCallback,
    );
    if (product === 'firefox') {
      __classPrivateFieldSet(
        ...
        new FirefoxTargetManager(
          connection,
          __classPrivateFieldGet(this, _CDPBrowser_createTarget, 'f'),
          __classPrivateFieldGet(this, _CDPBrowser_targetFilterCallback, 'f'),
        ),
        'f',
      );
    } else {
    ...
    __classPrivateFieldSet(
      this,
      _CDPBrowser_defaultContext,
      new CDPBrowserContext(__classPrivateFieldGet(this, _CDPBrowser_connection, 'f'), this),
      'f',
    );
    __classPrivateFieldSet(this, _CDPBrowser_contexts, new Map(), 'f');
    for (const contextId of contextIds) {
      __classPrivateFieldGet(this, _CDPBrowser_contexts, 'f').set(
        contextId,
        new CDPBrowserContext(__classPrivateFieldGet(this, _CDPBrowser_connection, 'f'), this, contextId),
      );
    }
  }
  /**
   ...
   */
  async _attach() {
    __classPrivateFieldGet(this, _CDPBrowser_connection, 'f').on(
      ConnectionEmittedEvents.Disconnected,
      __classPrivateFieldGet(this, _CDPBrowser_emitDisconnected, 'f'),
    );
    __classPrivateFieldGet(this, _CDPBrowser_targetManager, 'f').on(
      'targetAvailable' /* TargetManagerEmittedEvents.TargetAvailable */,
      __classPrivateFieldGet(this, _CDPBrowser_onAttachedToTarget, 'f'),
    );
    __classPrivateFieldGet(this, _CDPBrowser_targetManager, 'f').on(
      'targetGone' /* TargetManagerEmittedEvents.TargetGone */,
      __classPrivateFieldGet(this, _CDPBrowser_onDetachedFromTarget, 'f'),
    );
    __classPrivateFieldGet(this, _CDPBrowser_targetManager, 'f').on(
      'targetChanged' /* TargetManagerEmittedEvents.TargetChanged */,
      __classPrivateFieldGet(this, _CDPBrowser_onTargetChanged, 'f'),
    );
    __classPrivateFieldGet(this, _CDPBrowser_targetManager, 'f').on(
      'targetDiscovered' /* TargetManagerEmittedEvents.TargetDiscovered */,
      __classPrivateFieldGet(this, _CDPBrowser_onTargetDiscovered, 'f'),
    );
   ...
   */
  _detach() {
    __classPrivateFieldGet(this, _CDPBrowser_connection, 'f').off(
      ConnectionEmittedEvents.Disconnected,
      __classPrivateFieldGet(this, _CDPBrowser_emitDisconnected, 'f'),
    );
    __classPrivateFieldGet(this, _CDPBrowser_targetManager, 'f').off(
      'targetAvailable' /* TargetManagerEmittedEvents.TargetAvailable */,
      __classPrivateFieldGet(this, _CDPBrowser_onAttachedToTarget, 'f'),
    );
    __classPrivateFieldGet(this, _CDPBrowser_targetManager, 'f').off(
  ...
  async createIncognitoBrowserContext(options = {}) {
    ...
    const { browserContextId } = await __classPrivateFieldGet(this, _CDPBrowser_connection, 'f').send(
    ...
    const context = new CDPBrowserContext(
      __classPrivateFieldGet(this, _CDPBrowser_connection, 'f'),
      this,
      browserContextId,
    );
  ...
  browserContexts() {
    return [
      __classPrivateFieldGet(this, _CDPBrowser_defaultContext, 'f'),
      ...Array.from(__classPrivateFieldGet(this, _CDPBrowser_contexts, 'f').values()),
    ];
  }
  /**
  ...
  targets() {
    return Array.from(
      __classPrivateFieldGet(this, _CDPBrowser_targetManager, 'f').getAvailableTargets().values(),
    ).filter((target) => {
...
(_CDPBrowser_ignoreHTTPSErrors = new WeakMap()),
  (_CDPBrowser_defaultViewport = new WeakMap()),
  (_CDPBrowser_process = new WeakMap()),
  (_CDPBrowser_connection = new WeakMap()),
  (_CDPBrowser_closeCallback = new WeakMap()),
  (_CDPBrowser_targetFilterCallback = new WeakMap()),
  (_CDPBrowser_isPageTargetCallback = new WeakMap()),
  (_CDPBrowser_defaultContext = new WeakMap()),
  (_CDPBrowser_contexts = new WeakMap()),
  (_CDPBrowser_screenshotTaskQueue = new WeakMap()),
  (_CDPBrowser_targetManager = new WeakMap()),
  (_CDPBrowser_emitDisconnected = new WeakMap()),
  (_CDPBrowser_createTarget = new WeakMap()),
  (_CDPBrowser_onAttachedToTarget = new WeakMap()),
  (_CDPBrowser_onDetachedFromTarget = new WeakMap()),
  (_CDPBrowser_onTargetChanged = new WeakMap()),
  (_CDPBrowser_onTargetDiscovered = new WeakMap()),
  (_CDPBrowser_instances = new WeakSet()),
  (_CDPBrowser_setIsPageTargetCallback = function _CDPBrowser_setIsPageTargetCallback(isPageTargetCallback) {
    __classPrivateFieldSet(
      this,
      _CDPBrowser_isPageTargetCallback,
      isPageTargetCallback ||
...
export class CDPBrowserContext extends BrowserContext {
      ...
      this.targets()
        .filter((target) => {
          ...
          return (
            target.type() === 'page' ||
            (target.type() === 'other' &&
              ((_a = __classPrivateFieldGet(this, _CDPBrowserContext_browser, 'f')._getIsPageTargetCallback()) ===
                null || _a === void 0
                ? void 0
   ...
   */
  newPage() {
    return __classPrivateFieldGet(this, _CDPBrowserContext_browser, 'f')._createPageInContext(
      __classPrivateFieldGet(this, _CDPBrowserContext_id, 'f'),
    );
  }
  /**
  ...
  async close() {
    ...
    await __classPrivateFieldGet(this, _CDPBrowserContext_browser, 'f')._disposeContext(
      __classPrivateFieldGet(this, _CDPBrowserContext_id, 'f'),
    );
  }
}
(_CDPBrowserContext_connection = new WeakMap()),
  (_CDPBrowserContext_browser = new WeakMap()),
  (_CDPBrowserContext_id = new WeakMap());
