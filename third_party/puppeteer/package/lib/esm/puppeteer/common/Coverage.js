    ...
    __classPrivateFieldSet(
      ...
      [
        addEventListener(
          ...
          __classPrivateFieldGet(this, _JSCoverage_instances, 'm', _JSCoverage_onScriptParsed).bind(this),
        ),
        addEventListener(
          __classPrivateFieldGet(this, _JSCoverage_client, 'f'),
          'Runtime.executionContextsCleared',
          __classPrivateFieldGet(this, _JSCoverage_instances, 'm', _JSCoverage_onExecutionContextsCleared).bind(this),
        ),
      ],
      'f',
    );
...
(_JSCoverage_client = new WeakMap()),
  ...
  (_JSCoverage_onExecutionContextsCleared = function _JSCoverage_onExecutionContextsCleared() {
...
export class CSSCoverage {
    ...
    __classPrivateFieldSet(
      ...
      [
        addEventListener(
          ...
          'CSS.styleSheetAdded',
          __classPrivateFieldGet(this, _CSSCoverage_instances, 'm', _CSSCoverage_onStyleSheet).bind(this),
        ),
        addEventListener(
          __classPrivateFieldGet(this, _CSSCoverage_client, 'f'),
          'Runtime.executionContextsCleared',
          __classPrivateFieldGet(this, _CSSCoverage_instances, 'm', _CSSCoverage_onExecutionContextsCleared).bind(this),
        ),
      ],
      'f',
    );
  ...
  async stop() {
    ...
    const ruleTrackingResponse = await __classPrivateFieldGet(this, _CSSCoverage_client, 'f').send(
...
(_CSSCoverage_client = new WeakMap()),
  ...
  (_CSSCoverage_onExecutionContextsCleared = function _CSSCoverage_onExecutionContextsCleared() {
