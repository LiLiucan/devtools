...
export class ElementHandle extends JSHandle {
  ...
  async contentFrame() {
    ...
    return __classPrivateFieldGet(this, _ElementHandle_instances, 'a', _ElementHandle_frameManager_get).frame(
  ...
  async clickablePoint(offset) {
    const [result, layoutMetrics] = await Promise.all([
      this.client
        ...
        .catch(debugError),
      __classPrivateFieldGet(this, _ElementHandle_instances, 'a', _ElementHandle_page_get)
        ._client()
    ...
    const quads = result.quads
      .map((quad) => {
        return __classPrivateFieldGet(this, _ElementHandle_instances, 'm', _ElementHandle_fromProtocolQuad).call(
          this,
          quad,
        );
      })
  ...
  async click(options = {}) {
    ...
    await __classPrivateFieldGet(this, _ElementHandle_instances, 'a', _ElementHandle_page_get).mouse.click(
      x,
      y,
      options,
    );
  ...
  async drag(target) {
    assert(
      __classPrivateFieldGet(this, _ElementHandle_instances, 'a', _ElementHandle_page_get).isDragInterceptionEnabled(),
      'Drag Interception is not enabled!',
    );
    await __classPrivateFieldGet(this, _ElementHandle_instances, 'm', _ElementHandle_scrollIntoViewIfNeeded).call(this);
    const start = await this.clickablePoint();
    return await __classPrivateFieldGet(this, _ElementHandle_instances, 'a', _ElementHandle_page_get).mouse.drag(
      start,
      target,
    );
  }
  ...
  async dragEnter(data = { items: [], dragOperationsMask: 1 }) {
    ...
    await __classPrivateFieldGet(this, _ElementHandle_instances, 'a', _ElementHandle_page_get).mouse.dragEnter(
      target,
      data,
    );
  }
  ...
  async dragOver(data = { items: [], dragOperationsMask: 1 }) {
    await __classPrivateFieldGet(this, _ElementHandle_instances, 'm', _ElementHandle_scrollIntoViewIfNeeded).call(this);
    const target = await this.clickablePoint();
    await __classPrivateFieldGet(this, _ElementHandle_instances, 'a', _ElementHandle_page_get).mouse.dragOver(
      target,
      data,
    );
  }
  ...
  async drop(data = { items: [], dragOperationsMask: 1 }) {
    ...
    await __classPrivateFieldGet(this, _ElementHandle_instances, 'a', _ElementHandle_page_get).mouse.drop(
      destination,
      data,
    );
  }
  ...
  async dragAndDrop(target, options) {
    ...
    await __classPrivateFieldGet(this, _ElementHandle_instances, 'a', _ElementHandle_page_get).mouse.dragAndDrop(
      startPoint,
      targetPoint,
      options,
    );
  ...
  async type(text, options) {
    await this.focus();
    await __classPrivateFieldGet(this, _ElementHandle_instances, 'a', _ElementHandle_page_get).keyboard.type(
      text,
      options,
    );
  }
  ...
  async press(key, options) {
    await this.focus();
    await __classPrivateFieldGet(this, _ElementHandle_instances, 'a', _ElementHandle_page_get).keyboard.press(
      key,
      options,
    );
  }
   ...
   */
  async boundingBox() {
    const result = await __classPrivateFieldGet(this, _ElementHandle_instances, 'm', _ElementHandle_getBoxModel).call(
      this,
    );
    if (!result) {
      return null;
  ...
  async boxModel() {
    ...
    return {
      content: applyOffsetsToQuad(
        __classPrivateFieldGet(this, _ElementHandle_instances, 'm', _ElementHandle_fromProtocolQuad).call(
          this,
          content,
        ),
        offsetX,
      ...
      border: applyOffsetsToQuad(
        __classPrivateFieldGet(this, _ElementHandle_instances, 'm', _ElementHandle_fromProtocolQuad).call(this, border),
        offsetX,
        offsetY,
      ),
      margin: applyOffsetsToQuad(
        __classPrivateFieldGet(this, _ElementHandle_instances, 'm', _ElementHandle_fromProtocolQuad).call(this, margin),
        offsetX,
        offsetY,
      ),
      width,
  ...
  async screenshot(options = {}) {
    ...
    if (viewport && (boundingBox.width > viewport.width || boundingBox.height > viewport.height)) {
      ...
      await __classPrivateFieldGet(this, _ElementHandle_instances, 'a', _ElementHandle_page_get).setViewport(
...
(_ElementHandle_frame = new WeakMap()),
  ...
  (_ElementHandle_frameManager_get = function _ElementHandle_frameManager_get() {
