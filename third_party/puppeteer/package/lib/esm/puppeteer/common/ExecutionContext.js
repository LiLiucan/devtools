...
export class ExecutionContext {
  ...
  async evaluate(pageFunction, ...args) {
    return await __classPrivateFieldGet(this, _ExecutionContext_instances, 'm', _ExecutionContext_evaluate).call(
      this,
      true,
      pageFunction,
      ...args,
  ...
  async evaluateHandle(pageFunction, ...args) {
    return __classPrivateFieldGet(this, _ExecutionContext_instances, 'm', _ExecutionContext_evaluate).call(
      this,
      false,
      pageFunction,
      ...args,
