...
export class FirefoxTargetManager extends EventEmitter {
  constructor(connection, targetFactory, targetFilterCallback) {
    ...
    _FirefoxTargetManager_initializePromise.set(
      this,
      new Promise((resolve) => {
    ...
    _FirefoxTargetManager_onTargetCreated.set(this, async (event) => {
      if (
        __classPrivateFieldGet(this, _FirefoxTargetManager_discoveredTargetsByTargetId, 'f').has(
          event.targetInfo.targetId,
        )
      ) {
        return;
      }
      __classPrivateFieldGet(this, _FirefoxTargetManager_discoveredTargetsByTargetId, 'f').set(
        event.targetInfo.targetId,
        event.targetInfo,
      );
      if (event.targetInfo.type === 'browser' && event.targetInfo.attached) {
        const target = __classPrivateFieldGet(this, _FirefoxTargetManager_targetFactory, 'f').call(
          this,
          event.targetInfo,
          undefined,
        );
        __classPrivateFieldGet(this, _FirefoxTargetManager_availableTargetsByTargetId, 'f').set(
          event.targetInfo.targetId,
          target,
        );
        __classPrivateFieldGet(
          ...
          'm',
          _FirefoxTargetManager_finishInitializationIfReady,
        ).call(this, target._targetId);
        return;
      }
      if (
        __classPrivateFieldGet(this, _FirefoxTargetManager_targetFilterCallback, 'f') &&
        ...
        __classPrivateFieldGet(
          ...
          'm',
          _FirefoxTargetManager_finishInitializationIfReady,
        ).call(this, event.targetInfo.targetId);
        return;
      }
      const target = __classPrivateFieldGet(this, _FirefoxTargetManager_targetFactory, 'f').call(
        this,
    ...
    _FirefoxTargetManager_onTargetDestroyed.set(this, (event) => {
      ...
      const target = __classPrivateFieldGet(this, _FirefoxTargetManager_availableTargetsByTargetId, 'f').get(
        event.targetId,
      );
      if (target) {
    ...
    _FirefoxTargetManager_onAttachedToTarget.set(this, async (parentSession, event) => {
      ...
      __classPrivateFieldGet(this, _FirefoxTargetManager_availableTargetsBySessionId, 'f').set(
        session.id(),
        __classPrivateFieldGet(this, _FirefoxTargetManager_availableTargetsByTargetId, 'f').get(targetInfo.targetId),
      );
      for (const hook of __classPrivateFieldGet(this, _FirefoxTargetManager_targetInterceptors, 'f').get(
        parentSession,
      ) || []) {
        if (!(parentSession instanceof Connection)) {
          assert(
            __classPrivateFieldGet(this, _FirefoxTargetManager_availableTargetsBySessionId, 'f').has(
              parentSession.id(),
            ),
          );
        }
        await hook(
          ...
          parentSession instanceof Connection
            ? null
            : __classPrivateFieldGet(this, _FirefoxTargetManager_availableTargetsBySessionId, 'f').get(
                parentSession.id(),
              ),
        );
      }
    ...
    __classPrivateFieldGet(this, _FirefoxTargetManager_connection, 'f').on(
      'Target.targetCreated',
      __classPrivateFieldGet(this, _FirefoxTargetManager_onTargetCreated, 'f'),
    );
    __classPrivateFieldGet(this, _FirefoxTargetManager_connection, 'f').on(
      'Target.targetDestroyed',
      __classPrivateFieldGet(this, _FirefoxTargetManager_onTargetDestroyed, 'f'),
    );
    __classPrivateFieldGet(this, _FirefoxTargetManager_connection, 'f').on(
      'sessiondetached',
      __classPrivateFieldGet(this, _FirefoxTargetManager_onSessionDetached, 'f'),
    );
  ...
  removeTargetInterceptor(client, interceptor) {
    const interceptors = __classPrivateFieldGet(this, _FirefoxTargetManager_targetInterceptors, 'f').get(client) || [];
    __classPrivateFieldGet(this, _FirefoxTargetManager_targetInterceptors, 'f').set(
      client,
  ...
  removeSessionListeners(session) {
    if (__classPrivateFieldGet(this, _FirefoxTargetManager_attachedToTargetListenersBySession, 'f').has(session)) {
      session.off(
        ...
        __classPrivateFieldGet(this, _FirefoxTargetManager_attachedToTargetListenersBySession, 'f').get(session),
      );
  ...
  dispose() {
    __classPrivateFieldGet(this, _FirefoxTargetManager_connection, 'f').off(
      'Target.targetCreated',
      __classPrivateFieldGet(this, _FirefoxTargetManager_onTargetCreated, 'f'),
    );
    __classPrivateFieldGet(this, _FirefoxTargetManager_connection, 'f').off(
  ...
  async initialize() {
    ...
    __classPrivateFieldSet(
      this,
      _FirefoxTargetManager_targetsIdsForInit,
      new Set(__classPrivateFieldGet(this, _FirefoxTargetManager_discoveredTargetsByTargetId, 'f').keys()),
      'f',
    );
    await __classPrivateFieldGet(this, _FirefoxTargetManager_initializePromise, 'f');
  }
}
(_FirefoxTargetManager_connection = new WeakMap()),
  (_FirefoxTargetManager_discoveredTargetsByTargetId = new WeakMap()),
  (_FirefoxTargetManager_availableTargetsByTargetId = new WeakMap()),
  (_FirefoxTargetManager_availableTargetsBySessionId = new WeakMap()),
  (_FirefoxTargetManager_ignoredTargets = new WeakMap()),
  (_FirefoxTargetManager_targetFilterCallback = new WeakMap()),
  (_FirefoxTargetManager_targetFactory = new WeakMap()),
  (_FirefoxTargetManager_targetInterceptors = new WeakMap()),
  (_FirefoxTargetManager_attachedToTargetListenersBySession = new WeakMap()),
  (_FirefoxTargetManager_initializeCallback = new WeakMap()),
  (_FirefoxTargetManager_initializePromise = new WeakMap()),
  (_FirefoxTargetManager_targetsIdsForInit = new WeakMap()),
  (_FirefoxTargetManager_onSessionDetached = new WeakMap()),
  (_FirefoxTargetManager_onTargetCreated = new WeakMap()),
  (_FirefoxTargetManager_onTargetDestroyed = new WeakMap()),
  (_FirefoxTargetManager_onAttachedToTarget = new WeakMap()),
  (_FirefoxTargetManager_instances = new WeakSet()),
  (_FirefoxTargetManager_finishInitializationIfReady = function _FirefoxTargetManager_finishInitializationIfReady(
    targetId,
  ) {
