...
export class FrameManager extends EventEmitter {
  ...
  setupEventListeners(session) {
    session.on('Page.frameAttached', (event) => {
      __classPrivateFieldGet(this, _FrameManager_instances, 'm', _FrameManager_onFrameAttached).call(
        this,
        session,
        event.frameId,
        event.parentFrameId,
    ...
    session.on('Page.frameNavigated', (event) => {
      __classPrivateFieldGet(this, _FrameManager_instances, 'm', _FrameManager_onFrameNavigated).call(
        this,
        event.frame,
      );
    });
    session.on('Page.navigatedWithinDocument', (event) => {
      __classPrivateFieldGet(this, _FrameManager_instances, 'm', _FrameManager_onFrameNavigatedWithinDocument).call(
        this,
        event.frameId,
        event.url,
      );
    ...
    session.on('Page.frameDetached', (event) => {
      __classPrivateFieldGet(this, _FrameManager_instances, 'm', _FrameManager_onFrameDetached).call(
        this,
        event.frameId,
        event.reason,
      );
    ...
    session.on('Page.frameStartedLoading', (event) => {
      __classPrivateFieldGet(this, _FrameManager_instances, 'm', _FrameManager_onFrameStartedLoading).call(
        this,
        event.frameId,
      );
    });
    session.on('Page.frameStoppedLoading', (event) => {
      __classPrivateFieldGet(this, _FrameManager_instances, 'm', _FrameManager_onFrameStoppedLoading).call(
        this,
        event.frameId,
      );
    });
    session.on('Runtime.executionContextCreated', (event) => {
      __classPrivateFieldGet(this, _FrameManager_instances, 'm', _FrameManager_onExecutionContextCreated).call(
        this,
        event.context,
        session,
      );
    ...
    session.on('Runtime.executionContextDestroyed', (event) => {
      __classPrivateFieldGet(this, _FrameManager_instances, 'm', _FrameManager_onExecutionContextDestroyed).call(
        this,
    ...
    session.on('Runtime.executionContextsCleared', () => {
      __classPrivateFieldGet(this, _FrameManager_instances, 'm', _FrameManager_onExecutionContextsCleared).call(
        this,
        session,
      );
    });
  ...
  async initialize(client = __classPrivateFieldGet(this, _FrameManager_client, 'f')) {
    try {
      ...
      __classPrivateFieldGet(this, _FrameManager_instances, 'm', _FrameManager_handleFrameTree).call(
        this,
        client,
        frameTree,
      );
      await Promise.all([
        ...
        client.send('Runtime.enable').then(() => {
          return __classPrivateFieldGet(this, _FrameManager_instances, 'm', _FrameManager_createIsolatedWorld).call(
            this,
            client,
            UTILITY_WORLD_NAME,
          );
  ...
  onDetachedFromTarget(target) {
    ...
    if (frame && frame.isOOPFrame()) {
      ...
      __classPrivateFieldGet(this, _FrameManager_instances, 'm', _FrameManager_removeFramesRecursively).call(
        this,
        frame,
      );
    }
...
(_FrameManager_page = new WeakMap()),
  ...
  (_FrameManager_onExecutionContextDestroyed = function _FrameManager_onExecutionContextDestroyed(
    executionContextId,
    session,
  ) {
