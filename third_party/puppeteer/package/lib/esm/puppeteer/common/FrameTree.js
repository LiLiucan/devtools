...
export class FrameTree {
  ...
  addFrame(frame) {
    ...
    (_a = __classPrivateFieldGet(this, _FrameTree_waitRequests, 'f').get(frame._id)) === null || _a === void 0
      ? void 0
      : _a.forEach((request) => {
  ...
  removeFrame(frame) {
    ...
    if (frame._parentId) {
      (_a = __classPrivateFieldGet(this, _FrameTree_childIds, 'f').get(frame._parentId)) === null || _a === void 0
        ? void 0
        : _a.delete(frame._id);
    } else {
...
(_FrameTree_frames = new WeakMap()),
  (_FrameTree_parentIds = new WeakMap()),
  (_FrameTree_childIds = new WeakMap()),
  (_FrameTree_mainFrame = new WeakMap()),
  (_FrameTree_waitRequests = new WeakMap());
