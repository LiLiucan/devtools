...
export class HTTPResponse {
  ...
  constructor(client, request, responsePayload, extraInfo) {
    ...
    __classPrivateFieldSet(
      this,
      _HTTPResponse_statusText,
      __classPrivateFieldGet(this, _HTTPResponse_instances, 'm', _HTTPResponse_parseStatusTextFromExtrInfo).call(
        this,
        extraInfo,
    ...
    __classPrivateFieldSet(
      this,
      _HTTPResponse_securityDetails,
      responsePayload.securityDetails ? new SecurityDetails(responsePayload.securityDetails) : null,
      'f',
    );
  ...
  ok() {
    ...
    return (
      __classPrivateFieldGet(this, _HTTPResponse_status, 'f') === 0 ||
  ...
  buffer() {
    if (!__classPrivateFieldGet(this, _HTTPResponse_contentPromise, 'f')) {
      __classPrivateFieldSet(
        this,
        _HTTPResponse_contentPromise,
        __classPrivateFieldGet(this, _HTTPResponse_bodyLoadedPromise, 'f').then(async (error) => {
          if (error) {
            throw error;
          }
          try {
            const response = await __classPrivateFieldGet(this, _HTTPResponse_client, 'f').send(
  ...
  fromCache() {
    return (
      __classPrivateFieldGet(this, _HTTPResponse_fromDiskCache, 'f') ||
...
(_HTTPResponse_client = new WeakMap()),
  ...
  (_HTTPResponse_parseStatusTextFromExtrInfo = function _HTTPResponse_parseStatusTextFromExtrInfo(extraInfo) {
