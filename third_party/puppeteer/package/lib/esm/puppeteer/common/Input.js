...
export class Keyboard {
  ...
  async down(key, options = { text: undefined }) {
    const description = __classPrivateFieldGet(this, _Keyboard_instances, 'm', _Keyboard_keyDescriptionForString).call(
      this,
      key,
    );
    ...
    this._modifiers |= __classPrivateFieldGet(this, _Keyboard_instances, 'm', _Keyboard_modifierBit).call(
      this,
      description.key,
    );
