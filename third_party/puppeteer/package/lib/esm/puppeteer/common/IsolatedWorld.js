...
export class IsolatedWorld {
  constructor(frame) {
    ...
    _IsolatedWorld_onBindingCalled.set(this, async (event) => {
      ...
      if (
        ...
        !__classPrivateFieldGet(this, _IsolatedWorld_ctxBindings, 'f').has(
          __classPrivateFieldGet(IsolatedWorld, _a, 'f', _IsolatedWorld_bindingIdentifier).call(
            IsolatedWorld,
            name,
            context._contextId,
          ),
    ...
    __classPrivateFieldGet(this, _IsolatedWorld_instances, 'a', _IsolatedWorld_client_get).on(
  ...
  _detach() {
    ...
    __classPrivateFieldGet(this, _IsolatedWorld_instances, 'a', _IsolatedWorld_client_get).off(
      'Runtime.bindingCalled',
      __classPrivateFieldGet(this, _IsolatedWorld_onBindingCalled, 'f'),
    );
    __classPrivateFieldGet(this, _IsolatedWorld_taskManager, 'f').terminateAll(
  ...
  executionContext() {
    if (__classPrivateFieldGet(this, _IsolatedWorld_detached, 'f')) {
      throw new Error(
        `Execution context is not available in detached frame "${__classPrivateFieldGet(
          this,
          _IsolatedWorld_frame,
          'f',
        ).url()}" (are you trying to evaluate?)`,
      );
    }
  ...
  async setContent(html, options = {}) {
    ...
    const watcher = new LifecycleWatcher(
      __classPrivateFieldGet(this, _IsolatedWorld_instances, 'a', _IsolatedWorld_frameManager_get),
  ...
  async adoptHandle(handle) {
    ...
    const nodeInfo = await __classPrivateFieldGet(this, _IsolatedWorld_instances, 'a', _IsolatedWorld_client_get).send(
      'DOM.describeNode',
      {
...
(_a = IsolatedWorld),
  ...
  (_IsolatedWorld_document = new WeakMap()),
  (_IsolatedWorld_context = new WeakMap()),
  (_IsolatedWorld_detached = new WeakMap()),
  (_IsolatedWorld_ctxBindings = new WeakMap()),
  (_IsolatedWorld_boundFunctions = new WeakMap()),
  (_IsolatedWorld_taskManager = new WeakMap()),
  (_IsolatedWorld_puppeteerUtil = new WeakMap()),
  ...
  (_IsolatedWorld_client_get = function _IsolatedWorld_client_get() {
  ...
  (_IsolatedWorld_injectPuppeteerUtil = async function _IsolatedWorld_injectPuppeteerUtil(context) {
    try {
      __classPrivateFieldGet(this, _IsolatedWorld_puppeteerUtil, 'f').resolve(
        await context.evaluateHandle(`(() => {
              const module = {};
              ${injectedSource}
