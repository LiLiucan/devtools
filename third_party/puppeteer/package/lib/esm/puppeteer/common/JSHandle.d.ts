...
export declare class JSHandle<T = unknown> {
   ...
   */
  evaluate<Params extends unknown[], Func extends EvaluateFunc<[this, ...Params]> = EvaluateFunc<[this, ...Params]>>(
  ...
  evaluateHandle<
    ...
    Func extends EvaluateFunc<[this, ...Params]> = EvaluateFunc<[this, ...Params]>,
