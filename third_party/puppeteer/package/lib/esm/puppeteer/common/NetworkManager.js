...
export class NetworkManager extends EventEmitter {
  constructor(client, ignoreHTTPSErrors, frameManager) {
    ...
    __classPrivateFieldGet(this, _NetworkManager_client, 'f').on(
      'Fetch.requestPaused',
      __classPrivateFieldGet(this, _NetworkManager_instances, 'm', _NetworkManager_onRequestPaused).bind(this),
    );
    __classPrivateFieldGet(this, _NetworkManager_client, 'f').on(
      'Fetch.authRequired',
      __classPrivateFieldGet(this, _NetworkManager_instances, 'm', _NetworkManager_onAuthRequired).bind(this),
    );
    __classPrivateFieldGet(this, _NetworkManager_client, 'f').on(
      'Network.requestWillBeSent',
      __classPrivateFieldGet(this, _NetworkManager_instances, 'm', _NetworkManager_onRequestWillBeSent).bind(this),
    );
    __classPrivateFieldGet(this, _NetworkManager_client, 'f').on(
      'Network.requestServedFromCache',
      __classPrivateFieldGet(this, _NetworkManager_instances, 'm', _NetworkManager_onRequestServedFromCache).bind(this),
    );
    __classPrivateFieldGet(this, _NetworkManager_client, 'f').on(
      'Network.responseReceived',
      __classPrivateFieldGet(this, _NetworkManager_instances, 'm', _NetworkManager_onResponseReceived).bind(this),
    );
    __classPrivateFieldGet(this, _NetworkManager_client, 'f').on(
      'Network.loadingFinished',
      __classPrivateFieldGet(this, _NetworkManager_instances, 'm', _NetworkManager_onLoadingFinished).bind(this),
    );
    __classPrivateFieldGet(this, _NetworkManager_client, 'f').on(
      'Network.loadingFailed',
      __classPrivateFieldGet(this, _NetworkManager_instances, 'm', _NetworkManager_onLoadingFailed).bind(this),
    );
    __classPrivateFieldGet(this, _NetworkManager_client, 'f').on(
      'Network.responseReceivedExtraInfo',
      __classPrivateFieldGet(this, _NetworkManager_instances, 'm', _NetworkManager_onResponseReceivedExtraInfo).bind(
        this,
      ),
    );
  }
  ...
  initialize() {
    ...
    __classPrivateFieldSet(
      this,
      _NetworkManager_deferredInitPromise,
      createDebuggableDeferredPromise('NetworkManager initialization timed out'),
      'f',
    );
  ...
  async setOfflineMode(value) {
    ...
    await __classPrivateFieldGet(this, _NetworkManager_instances, 'm', _NetworkManager_updateNetworkConditions).call(
      this,
    );
  }
...
(_NetworkManager_client = new WeakMap()),
  (_NetworkManager_ignoreHTTPSErrors = new WeakMap()),
  (_NetworkManager_frameManager = new WeakMap()),
  (_NetworkManager_networkEventManager = new WeakMap()),
  (_NetworkManager_extraHTTPHeaders = new WeakMap()),
  (_NetworkManager_credentials = new WeakMap()),
  (_NetworkManager_attemptedAuthentications = new WeakMap()),
  (_NetworkManager_userRequestInterceptionEnabled = new WeakMap()),
  (_NetworkManager_protocolRequestInterceptionEnabled = new WeakMap()),
  (_NetworkManager_userCacheDisabled = new WeakMap()),
  (_NetworkManager_emulatedNetworkConditions = new WeakMap()),
  (_NetworkManager_deferredInitPromise = new WeakMap()),
  (_NetworkManager_instances = new WeakSet()),
  (_NetworkManager_updateNetworkConditions = async function _NetworkManager_updateNetworkConditions() {
  ...
  (_NetworkManager_updateProtocolRequestInterception =
    async function _NetworkManager_updateProtocolRequestInterception() {
      const enabled =
        __classPrivateFieldGet(this, _NetworkManager_userRequestInterceptionEnabled, 'f') ||
  ...
  (_NetworkManager_updateProtocolCacheDisabled = async function _NetworkManager_updateProtocolCacheDisabled() {
    await __classPrivateFieldGet(this, _NetworkManager_client, 'f').send('Network.setCacheDisabled', {
      cacheDisabled: __classPrivateFieldGet(this, _NetworkManager_instances, 'm', _NetworkManager_cacheDisabled).call(
        this,
      ),
    });
  }),
  (_NetworkManager_onRequestWillBeSent = function _NetworkManager_onRequestWillBeSent(event) {
    ...
    if (
      ...
      __classPrivateFieldGet(this, _NetworkManager_networkEventManager, 'f').storeRequestWillBeSent(
        networkRequestId,
        event,
      );
      /**
       ...
       */
      const requestPausedEvent = __classPrivateFieldGet(
        this,
        _NetworkManager_networkEventManager,
        'f',
      ...
      if (requestPausedEvent) {
        ...
        __classPrivateFieldGet(this, _NetworkManager_instances, 'm', _NetworkManager_patchRequestEventHeaders).call(
          this,
          event,
          requestPausedEvent,
        );
        __classPrivateFieldGet(this, _NetworkManager_instances, 'm', _NetworkManager_onRequest).call(
          this,
          event,
          fetchRequestId,
        );
  ...
  (_NetworkManager_onRequestPaused = function _NetworkManager_onRequestPaused(event) {
    ...
    const requestWillBeSentEvent = (() => {
      const requestWillBeSentEvent = __classPrivateFieldGet(
        this,
        _NetworkManager_networkEventManager,
        'f',
      ...
      if (
        ...
        __classPrivateFieldGet(this, _NetworkManager_networkEventManager, 'f').forgetRequestWillBeSent(
          networkRequestId,
        );
        return;
      }
    ...
    if (requestWillBeSentEvent) {
      ...
      __classPrivateFieldGet(this, _NetworkManager_networkEventManager, 'f').storeRequestPaused(
        networkRequestId,
        event,
      );
    }
  }),
  (_NetworkManager_patchRequestEventHeaders = function _NetworkManager_patchRequestEventHeaders(
    requestWillBeSentEvent,
    requestPausedEvent,
  ) {
  ...
  (_NetworkManager_onRequest = function _NetworkManager_onRequest(event, fetchRequestId) {
    ...
    if (event.redirectResponse) {
      ...
      const request = __classPrivateFieldGet(this, _NetworkManager_networkEventManager, 'f').getRequest(
        event.requestId,
      );
      // If we connect late to the target, we could have missed the
      // requestWillBeSent event.
      if (request) {
        __classPrivateFieldGet(this, _NetworkManager_instances, 'm', _NetworkManager_handleRequestRedirect).call(
          this,
          request,
  ...
  (_NetworkManager_handleRequestRedirect = function _NetworkManager_handleRequestRedirect(
    request,
    responsePayload,
    extraInfo,
  ) {
    ...
    __classPrivateFieldGet(this, _NetworkManager_instances, 'm', _NetworkManager_forgetRequest).call(
      this,
      request,
      false,
    );
  ...
  (_NetworkManager_emitResponseEvent = function _NetworkManager_emitResponseEvent(responseReceived, extraInfo) {
    ...
    const extraInfos = __classPrivateFieldGet(this, _NetworkManager_networkEventManager, 'f').responseExtraInfo(
      responseReceived.requestId,
    );
  ...
  (_NetworkManager_onResponseReceived = function _NetworkManager_onResponseReceived(event) {
    ...
    __classPrivateFieldGet(this, _NetworkManager_instances, 'm', _NetworkManager_emitResponseEvent).call(
      this,
      event,
      extraInfo,
    );
  ...
  (_NetworkManager_onResponseReceivedExtraInfo = function _NetworkManager_onResponseReceivedExtraInfo(event) {
    ...
    // request.
    const redirectInfo = __classPrivateFieldGet(this, _NetworkManager_networkEventManager, 'f').takeQueuedRedirectInfo(
      event.requestId,
    );
    if (redirectInfo) {
    ...
    const queuedEvents = __classPrivateFieldGet(this, _NetworkManager_networkEventManager, 'f').getQueuedEventGroup(
      event.requestId,
    );
    if (queuedEvents) {
      ...
      if (queuedEvents.loadingFinishedEvent) {
        __classPrivateFieldGet(this, _NetworkManager_instances, 'm', _NetworkManager_emitLoadingFinished).call(
          this,
          queuedEvents.loadingFinishedEvent,
        );
      }
      if (queuedEvents.loadingFailedEvent) {
        __classPrivateFieldGet(this, _NetworkManager_instances, 'm', _NetworkManager_emitLoadingFailed).call(
          this,
          queuedEvents.loadingFailedEvent,
        );
      }
      return;
    }
