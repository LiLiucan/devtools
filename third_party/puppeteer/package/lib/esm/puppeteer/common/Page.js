...
export class CDPPage extends Page {
  ...
  constructor(client, target, ignoreHTTPSErrors, screenshotTaskQueue) {
    ...
    _CDPPage_onAttachedToTarget.set(this, async (createdTarget) => {
      ...
      if (createdTarget._getTargetInfo().type === 'worker') {
        ...
        const worker = new WebWorker(
          session,
          createdTarget.url(),
          __classPrivateFieldGet(this, _CDPPage_instances, 'm', _CDPPage_addConsoleMessage).bind(this),
          __classPrivateFieldGet(this, _CDPPage_instances, 'm', _CDPPage_handleException).bind(this),
        );
      ...
      if (createdTarget._session()) {
        __classPrivateFieldGet(this, _CDPPage_target, 'f')
          ...
          .addTargetInterceptor(
            ...
            __classPrivateFieldGet(this, _CDPPage_onAttachedToTarget, 'f'),
          );
      }
    });
    ...
    __classPrivateFieldSet(
      this,
      _CDPPage_mouse,
      new Mouse(client, __classPrivateFieldGet(this, _CDPPage_keyboard, 'f')),
      'f',
    );
    __classPrivateFieldSet(
      this,
      _CDPPage_touchscreen,
      new Touchscreen(client, __classPrivateFieldGet(this, _CDPPage_keyboard, 'f')),
      'f',
    );
    ...
    __classPrivateFieldSet(
      this,
      _CDPPage_frameManager,
      new FrameManager(client, this, ignoreHTTPSErrors, __classPrivateFieldGet(this, _CDPPage_timeoutSettings, 'f')),
      'f',
    );
    ...
    __classPrivateFieldGet(this, _CDPPage_target, 'f')
      ...
      .on(
        ...
        __classPrivateFieldGet(this, _CDPPage_onDetachedFromTarget, 'f'),
      );
    ...
    client.on('Runtime.exceptionThrown', (exception) => {
      return __classPrivateFieldGet(this, _CDPPage_instances, 'm', _CDPPage_handleException).call(
        this,
  ...
  emulateNetworkConditions(networkConditions) {
    return __classPrivateFieldGet(this, _CDPPage_frameManager, 'f').networkManager.emulateNetworkConditions(
      networkConditions,
    );
  }
  /**
  ...
  async cookies(...urls) {
    const originalCookies = (
      await __classPrivateFieldGet(this, _CDPPage_client, 'f').send('Network.getCookies', {
  ...
  async setUserAgent(userAgent, userAgentMetadata) {
    return __classPrivateFieldGet(this, _CDPPage_frameManager, 'f').networkManager.setUserAgent(
      userAgent,
      userAgentMetadata,
    );
  }
  ...
  async metrics() {
    ...
    return __classPrivateFieldGet(this, _CDPPage_instances, 'm', _CDPPage_buildMetricsObject).call(
      this,
      response.metrics,
    );
  }
  ...
  async waitForRequest(urlOrPredicate, options = {}) {
    const { timeout = __classPrivateFieldGet(this, _CDPPage_timeoutSettings, 'f').timeout() } = options;
    return waitForEvent(
      __classPrivateFieldGet(this, _CDPPage_frameManager, 'f').networkManager,
  ...
  async waitForFrame(urlOrPredicate, options = {}) {
    ...
    const eventRace = Promise.race([
      waitForEvent(
        __classPrivateFieldGet(this, _CDPPage_frameManager, 'f'),
  ...
  async emulateMediaType(type) {
    assert(
      type === 'screen' || type === 'print' || (type !== null && type !== void 0 ? type : undefined) === undefined,
  ...
  async evaluate(pageFunction, ...args) {
    return __classPrivateFieldGet(this, _CDPPage_frameManager, 'f')
      .mainFrame()
  ...
  async screenshot(options = {}) {
    ...
    return __classPrivateFieldGet(this, _CDPPage_screenshotTaskQueue, 'f').postTask(() => {
      return __classPrivateFieldGet(this, _CDPPage_instances, 'm', _CDPPage_screenshotTask).call(
        this,
        screenshotType,
        options,
      );
...
(_CDPPage_closed = new WeakMap()),
  (_CDPPage_client = new WeakMap()),
  (_CDPPage_target = new WeakMap()),
  (_CDPPage_keyboard = new WeakMap()),
  (_CDPPage_mouse = new WeakMap()),
  (_CDPPage_timeoutSettings = new WeakMap()),
  (_CDPPage_touchscreen = new WeakMap()),
  (_CDPPage_accessibility = new WeakMap()),
  (_CDPPage_frameManager = new WeakMap()),
  (_CDPPage_emulationManager = new WeakMap()),
  (_CDPPage_tracing = new WeakMap()),
  (_CDPPage_pageBindings = new WeakMap()),
  (_CDPPage_coverage = new WeakMap()),
  (_CDPPage_javascriptEnabled = new WeakMap()),
  (_CDPPage_viewport = new WeakMap()),
  (_CDPPage_screenshotTaskQueue = new WeakMap()),
  (_CDPPage_workers = new WeakMap()),
  (_CDPPage_fileChooserPromises = new WeakMap()),
  (_CDPPage_disconnectPromise = new WeakMap()),
  (_CDPPage_userDragInterceptionEnabled = new WeakMap()),
  (_CDPPage_onDetachedFromTarget = new WeakMap()),
  (_CDPPage_onAttachedToTarget = new WeakMap()),
  ...
  (_CDPPage_emitMetrics = function _CDPPage_emitMetrics(event) {
    this.emit('metrics' /* PageEmittedEvents.Metrics */, {
      title: event.title,
      metrics: __classPrivateFieldGet(this, _CDPPage_instances, 'm', _CDPPage_buildMetricsObject).call(
        this,
        event.metrics,
      ),
    });
  ...
  (_CDPPage_onConsoleAPI = async function _CDPPage_onConsoleAPI(event) {
    ...
    const context = __classPrivateFieldGet(this, _CDPPage_frameManager, 'f').executionContextById(
    ...
    __classPrivateFieldGet(this, _CDPPage_instances, 'm', _CDPPage_addConsoleMessage).call(
      this,
      event.type,
      values,
      event.stackTrace,
