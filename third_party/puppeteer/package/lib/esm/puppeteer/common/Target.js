...
export class Target {
  ...
  constructor(
    ...
    __classPrivateFieldSet(
      this,
      _Target_defaultViewport,
      defaultViewport !== null && defaultViewport !== void 0 ? defaultViewport : undefined,
      'f',
    );
  ...
  async page() {
    ...
    if (
      this._isPageTargetCallback(__classPrivateFieldGet(this, _Target_targetInfo, 'f')) &&
      !__classPrivateFieldGet(this, _Target_pagePromise, 'f')
    ) {
      __classPrivateFieldSet(
        this,
        _Target_pagePromise,
        (__classPrivateFieldGet(this, _Target_session, 'f')
          ? Promise.resolve(__classPrivateFieldGet(this, _Target_session, 'f'))
          : __classPrivateFieldGet(this, _Target_sessionFactory, 'f').call(this, true)
        ).then((client) => {
          var _a;
          return CDPPage._create(
            client,
            this,
            __classPrivateFieldGet(this, _Target_ignoreHTTPSErrors, 'f'),
            (_a = __classPrivateFieldGet(this, _Target_defaultViewport, 'f')) !== null && _a !== void 0 ? _a : null,
            __classPrivateFieldGet(this, _Target_screenshotTaskQueue, 'f'),
          );
        }),
        'f',
      );
  ...
  async worker() {
    if (
      __classPrivateFieldGet(this, _Target_targetInfo, 'f').type !== 'service_worker' &&
    ...
    if (!__classPrivateFieldGet(this, _Target_workerPromise, 'f')) {
      ...
      __classPrivateFieldSet(
        ...
        (__classPrivateFieldGet(this, _Target_session, 'f')
          ? Promise.resolve(__classPrivateFieldGet(this, _Target_session, 'f'))
          : __classPrivateFieldGet(this, _Target_sessionFactory, 'f').call(this, false)
        ).then((client) => {
...
(_Target_browserContext = new WeakMap()),
  (_Target_session = new WeakMap()),
  (_Target_targetInfo = new WeakMap()),
  (_Target_sessionFactory = new WeakMap()),
  (_Target_ignoreHTTPSErrors = new WeakMap()),
  (_Target_defaultViewport = new WeakMap()),
  (_Target_pagePromise = new WeakMap()),
  (_Target_workerPromise = new WeakMap()),
  (_Target_screenshotTaskQueue = new WeakMap()),
  (_Target_targetManager = new WeakMap());
