...
export class WaitTask {
  constructor(world, options, fn, ...args) {
    ...
    __classPrivateFieldSet(
      this,
      _WaitTask_bindings,
      (_a = options.bindings) !== null && _a !== void 0 ? _a : new Map(),
      'f',
    );
  ...
  async rerun() {
    try {
      if (__classPrivateFieldGet(this, _WaitTask_bindings, 'f').size !== 0) {
        ...
        await Promise.all(
          [...__classPrivateFieldGet(this, _WaitTask_bindings, 'f')].map(async ([name]) => {
      ...
      switch (__classPrivateFieldGet(this, _WaitTask_polling, 'f')) {
        case 'raf':
          __classPrivateFieldSet(
            this,
            _WaitTask_poller,
            await __classPrivateFieldGet(this, _WaitTask_world, 'f').evaluateHandle(
              ...
              await __classPrivateFieldGet(this, _WaitTask_world, 'f').puppeteerUtil,
              __classPrivateFieldGet(this, _WaitTask_fn, 'f'),
        ...
        case 'mutation':
          __classPrivateFieldSet(
            ...
            await __classPrivateFieldGet(this, _WaitTask_world, 'f').evaluateHandle(
              ...
              await __classPrivateFieldGet(this, _WaitTask_world, 'f').puppeteerUtil,
              __classPrivateFieldGet(this, _WaitTask_root, 'f'),
              __classPrivateFieldGet(this, _WaitTask_fn, 'f'),
              ...__classPrivateFieldGet(this, _WaitTask_args, 'f'),
            ),
            'f',
...
(_WaitTask_world = new WeakMap()),
  (_WaitTask_bindings = new WeakMap()),
  (_WaitTask_polling = new WeakMap()),
  (_WaitTask_root = new WeakMap()),
  (_WaitTask_fn = new WeakMap()),
  (_WaitTask_args = new WeakMap()),
  (_WaitTask_timeout = new WeakMap()),
  (_WaitTask_result = new WeakMap()),
  (_WaitTask_poller = new WeakMap());
/**
 * @internal
 */
export class TaskManager {
  ...
  async rerunAll() {
    await Promise.all(
      [...__classPrivateFieldGet(this, _TaskManager_tasks, 'f')].map((task) => {
        return task.rerun();
      }),
    );
  }
