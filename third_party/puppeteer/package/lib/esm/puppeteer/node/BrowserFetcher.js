...
var _BrowserFetcher_instances,
  ...
  _BrowserFetcher_downloadsFolder,
...
export class BrowserFetcher {
  ...
  constructor(projectRoot, options = {}) {
    ...
    assert(
      __classPrivateFieldGet(this, _BrowserFetcher_product, 'f') === 'chrome' ||
        __classPrivateFieldGet(this, _BrowserFetcher_product, 'f') === 'firefox',
    ...
    __classPrivateFieldSet(
      ...
      _BrowserFetcher_downloadsFolder,
      options.path ||
        path.join(projectRoot, browserConfig[__classPrivateFieldGet(this, _BrowserFetcher_product, 'f')].destination),
      'f',
    );
    __classPrivateFieldSet(
      this,
      _BrowserFetcher_downloadHost,
      options.host || browserConfig[__classPrivateFieldGet(this, _BrowserFetcher_product, 'f')].host,
      'f',
    );
    if (options.platform) {
          ...
          switch (__classPrivateFieldGet(this, _BrowserFetcher_product, 'f')) {
            case 'chrome':
              __classPrivateFieldSet(
                this,
                _BrowserFetcher_platform,
                os.arch() === 'arm64' && PUPPETEER_EXPERIMENTAL_CHROMIUM_MAC_ARM ? 'mac_arm' : 'mac',
                'f',
              );
              break;
            case 'firefox':
    ...
    assert(
      downloadURLs[__classPrivateFieldGet(this, _BrowserFetcher_product, 'f')][
        __classPrivateFieldGet(this, _BrowserFetcher_platform, 'f')
      ],
      'Unsupported platform: ' + __classPrivateFieldGet(this, _BrowserFetcher_platform, 'f'),
    );
  }
  /**
  ...
  canDownload(revision) {
    const url = downloadURL(
      __classPrivateFieldGet(this, _BrowserFetcher_product, 'f'),
      __classPrivateFieldGet(this, _BrowserFetcher_platform, 'f'),
      __classPrivateFieldGet(this, _BrowserFetcher_downloadHost, 'f'),
      revision,
    );
    return new Promise((resolve) => {
  ...
  async download(revision, progressCallback = () => {}) {
    ...
    const outputPath = __classPrivateFieldGet(this, _BrowserFetcher_instances, 'm', _BrowserFetcher_getFolderPath).call(
      this,
      revision,
    );
  ...
  async localRevisions() {
    ...
    return fileNames
      ...
      .filter((entry) => {
        var _a;
        return (_a = entry && entry.platform === __classPrivateFieldGet(this, _BrowserFetcher_platform, 'f')) !==
          null && _a !== void 0
          ? _a
          : false;
      })
  ...
  async remove(revision) {
    const folderPath = __classPrivateFieldGet(this, _BrowserFetcher_instances, 'm', _BrowserFetcher_getFolderPath).call(
      this,
      revision,
    );
  ...
  revisionInfo(revision) {
    ...
    if (__classPrivateFieldGet(this, _BrowserFetcher_product, 'f') === 'chrome') {
      if (
        __classPrivateFieldGet(this, _BrowserFetcher_platform, 'f') === 'mac' ||
        __classPrivateFieldGet(this, _BrowserFetcher_platform, 'f') === 'mac_arm'
      ) {
        ...
        __classPrivateFieldGet(this, _BrowserFetcher_platform, 'f') === 'win32' ||
        __classPrivateFieldGet(this, _BrowserFetcher_platform, 'f') === 'win64'
      ) {
        executablePath = path.join(
          folderPath,
          archiveName(
...
(_BrowserFetcher_product = new WeakMap()),
  (_BrowserFetcher_downloadsFolder = new WeakMap()),
  (_BrowserFetcher_downloadHost = new WeakMap()),
  (_BrowserFetcher_platform = new WeakMap()),
  (_BrowserFetcher_instances = new WeakSet()),
  (_BrowserFetcher_getFolderPath = function _BrowserFetcher_getFolderPath(revision) {
    return path.resolve(
      __classPrivateFieldGet(this, _BrowserFetcher_downloadsFolder, 'f'),
      `${__classPrivateFieldGet(this, _BrowserFetcher_platform, 'f')}-${revision}`,
    );
  });
