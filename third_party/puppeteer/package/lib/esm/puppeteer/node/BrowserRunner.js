...
export class BrowserRunner {
  ...
  start(options) {
    ...
    debugLauncher(
      `Calling ${__classPrivateFieldGet(this, _BrowserRunner_executablePath, 'f')} ${__classPrivateFieldGet(
        this,
        _BrowserRunner_processArguments,
        'f',
      ).join(' ')}`,
    ...
    this.proc = childProcess.spawn(
      __classPrivateFieldGet(this, _BrowserRunner_executablePath, 'f'),
      __classPrivateFieldGet(this, _BrowserRunner_processArguments, 'f'),
      {
            ...
            if (__classPrivateFieldGet(this, _BrowserRunner_product, 'f') === 'firefox') {
              try {
                ...
                const prefsBackupPath = path.join(
                  __classPrivateFieldGet(this, _BrowserRunner_userDataDir, 'f'),
                  'prefs.js.puppeteer',
                );
    ...
    __classPrivateFieldSet(
      this,
      _BrowserRunner_listeners,
      [addEventListener(process, 'exit', this.kill.bind(this))],
      'f',
    );
    if (handleSIGINT) {
      __classPrivateFieldGet(this, _BrowserRunner_listeners, 'f').push(
...
(_BrowserRunner_product = new WeakMap()),
  (_BrowserRunner_executablePath = new WeakMap()),
  (_BrowserRunner_processArguments = new WeakMap()),
  (_BrowserRunner_userDataDir = new WeakMap()),
  (_BrowserRunner_isTempUserDataDir = new WeakMap()),
  (_BrowserRunner_closed = new WeakMap()),
  (_BrowserRunner_listeners = new WeakMap()),
  (_BrowserRunner_processClosing = new WeakMap());
