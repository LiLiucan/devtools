...
export class DataGrid extends HTMLElement {
  ...
  #shouldAutoScrollToBottom() {
     ...
     */
    if (
      !this.#userHasFocusInDataGrid &&
      this.#userScrollState !== 'MANUAL_SCROLL_NOT_BOTTOM' /* UserScrollState.MANUAL_SCROLL_NOT_BOTTOM */
    ) {
      return true;
    }
    /**
  ...
  #focusCellIfRequired([newColumnIndex, newRowIndex]) {
    ...
    if (
      this.#cellUserHasFocused &&
      this.#cellUserHasFocused[0] === newColumnIndex &&
  ...
  #onResizePointerMove(event) {
    ...
    const MAX_CELL_WIDTH_PERCENTAGE =
      this.#currentResize.leftCellColInitialPercentageWidth +
  ...
  #onScroll(event) {
    ...
    this.#userScrollState = userIsAtBottom
      ? 'SCROLLED_TO_BOTTOM' /* UserScrollState.SCROLLED_TO_BOTTOM */
      : 'MANUAL_SCROLL_NOT_BOTTOM' /* UserScrollState.MANUAL_SCROLL_NOT_BOTTOM */;
    void this.#render();
  }
  #alignScrollHandlers() {
          ...
          <thead>
            <tr @contextmenu=${this.#onHeaderContextMenu}>
              ${this.#columns.map((col, columnIndex) => {
                ...
                const cellIsFocusableCell =
                  anyColumnsSortable && columnIndex === tabbableCell[0] && tabbableCell[1] === 0;
                return LitHtml.html`<th class=${thClasses}
                  style=${LitHtml.Directives.ifDefined(
                    col.styles ? LitHtml.Directives.styleMap(col.styles) : undefined,
                  )}
                  ...
                  tabindex=${LitHtml.Directives.ifDefined(
                    anyColumnsSortable ? (cellIsFocusableCell ? '0' : '-1') : undefined,
                  )}
            ...
            ${LitHtml.Directives.repeat(
              ...
              (row) => {
                ...
                <tr
                  ...
                  class=${rowClasses}
                  style=${LitHtml.Directives.ifDefined(
                    row.styles ? LitHtml.Directives.styleMap(row.styles) : undefined,
                  )}
