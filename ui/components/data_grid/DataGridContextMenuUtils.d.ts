 ...
 */
export declare function addColumnVisibilityCheckboxes(
  dataGrid: DataGrid,
  contextMenu: UI.ContextMenu.ContextMenu | UI.ContextMenu.SubMenu,
): void;
/**
 ...
 */
export declare function addSortableColumnItems(
  dataGrid: DataGrid,
  contextMenu: UI.ContextMenu.ContextMenu | UI.ContextMenu.SubMenu,
): void;
