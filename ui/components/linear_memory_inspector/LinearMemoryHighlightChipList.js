...
const str_ = i18n.i18n.registerUIStrings(
  'ui/components/linear_memory_inspector/LinearMemoryHighlightChipList.ts',
  UIStrings,
);
...
export class LinearMemoryHighlightChipList extends HTMLElement {
  ...
  #render() {
    ...
    const result = html` <div class="highlight-chip-list">${chips}</div> `;
    ...
    return html`
      <div class=${LitHtml.Directives.classMap(classMap)}>
        ...
        <div class="delete-highlight-container">
          <button class="delete-highlight-button" title=${i18nString(UIStrings.deleteHighlight)} @click=${() =>
      this.#onDeleteHighlightClick(highlightInfo)}>
