...
export declare class LinearMemoryInspectorController extends SDK.TargetManager
  .SDKModelObserver<SDK.RuntimeModel.RuntimeModel> {
  #private;
  private constructor();
  static instance(): LinearMemoryInspectorController;
  static getMemoryForAddress(
  ...
  static retrieveDWARFMemoryObjectAndAddress(obj: SDK.RemoteObject.RemoteObject): Promise<
    ...
    | undefined
  >;
  static extractObjectSize(
    obj: Bindings.DebuggerLanguagePlugins.ValueNode | Bindings.DebuggerLanguagePlugins.ExtensionRemoteObject,
  ): number;
