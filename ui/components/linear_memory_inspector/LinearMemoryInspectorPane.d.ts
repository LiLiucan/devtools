...
declare const LinearMemoryInspectorPaneImpl_base: (new (...args: any[]) => {
  ...
  removeEventListener<T_2 extends Events.ViewClosed>(
    eventType: T_2,
  ...
  dispatchEventToListeners<T_3 extends Events.ViewClosed>(
