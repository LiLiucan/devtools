  ...
  #render() {
    ...
    LitHtml.render(
      ...
      <div class="preview">
        ...
        <p>${i18nString(UIStrings.previewText)} <x-link href=${this.#props.feedbackUrl}>${i18nString(
        UIStrings.previewTextFeedbackLink,
      )}</x-link></p>
        <div class="video">
          <div class="thumbnail">
          ...
          <div class="video-description">
            ...
            <x-link class="quick-start-link" href=${this.#props.quickStartUrl}>${
