...
export declare function completeInContext(
  textBefore: string,
  query: string,
  force?: boolean,
...
export declare function getQueryType(
...
export declare function javascriptCompletionSource(
  cx: CodeMirror.CompletionContext,
...
export declare function closeArgumentsHintsTooltip(
  view: CodeMirror.EditorView,
  tooltip: CodeMirror.StateField<CodeMirror.Tooltip | null>,
): boolean;
