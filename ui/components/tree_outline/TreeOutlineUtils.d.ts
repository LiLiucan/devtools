...
export declare function isExpandableNode<TreeNodeDataType>(
  node: TreeNode<TreeNodeDataType>,
...
export declare const trackDOMNodeToTreeNode: (
  _weakmap: WeakMap<HTMLLIElement, TreeNode<any>>,
  _treeNode: TreeNode<any>,
) => LitHtml.Directive.DirectiveResult<typeof TrackDOMNodeToTreeNode>;
export declare const getNodeChildren: <TreeNodeDataType>(
  node: TreeNode<TreeNodeDataType>,
 ...
 */
export declare const getPathToTreeNode: <TreeNodeDataType>(
  tree: readonly TreeNode<TreeNodeDataType>[],
  nodeIdToFind: TreeNodeId,
...
export declare const findNextNodeForTreeOutlineKeyboardNavigation: <TreeNodeDataType>(
  options: KeyboardNavigationOptions<TreeNodeDataType>,
) => HTMLLIElement;
export {};
