...
declare const FilterBar_base: (new (...args: any[]) => {
  ...
  addEventListener<T extends FilterBarEvents.Changed>(
    eventType: T,
    listener: (arg0: Common.EventTarget.EventTargetEvent<FilterBarEventTypes[T]>) => void,
    thisObject?: Object | undefined,
  ): Common.EventTarget.EventDescriptor<FilterBarEventTypes, T>;
  once<T_1 extends FilterBarEvents.Changed>(eventType: T_1): Promise<FilterBarEventTypes[T_1]>;
  removeEventListener<T_2 extends FilterBarEvents.Changed>(
    eventType: T_2,
    listener: (arg0: Common.EventTarget.EventTargetEvent<FilterBarEventTypes[T_2]>) => void,
    thisObject?: Object | undefined,
  ): void;
  hasEventListeners(eventType: FilterBarEvents.Changed): boolean;
  dispatchEventToListeners<T_3 extends FilterBarEvents.Changed>(
    eventType: Platform.TypeScriptUtilities.NoUnion<T_3>,
    ...eventData: Common.EventTarget.EventPayloadToRestParameters<FilterBarEventTypes, T_3>
  ): void;
}) &
  typeof HBox;
...
export declare class TextFilterUI extends Common.ObjectWrapper.ObjectWrapper<FilterUIEventTypes> implements FilterUI {
  ...
  setSuggestionProvider(
    suggestionProvider: (arg0: string, arg1: string, arg2?: boolean | undefined) => Promise<Suggestions>,
  ): void;
  private valueChanged;
  private updateEmptyStyles;
  clear(): void;
}
export declare class NamedBitSetFilterUI
  extends Common.ObjectWrapper.ObjectWrapper<FilterUIEventTypes>
  implements FilterUI
{
...
export declare class CheckboxFilterUI
  extends Common.ObjectWrapper.ObjectWrapper<FilterUIEventTypes>
  implements FilterUI
{
  private readonly filterElement;
