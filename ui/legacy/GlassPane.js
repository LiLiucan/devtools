...
export class GlassPane {
  ...
  setPointerEventsBehavior(pointerEventsBehavior) {
    this.element.classList.toggle(
      'no-pointer-events',
      pointerEventsBehavior !== 'BlockedByGlassPane' /* PointerEventsBehavior.BlockedByGlassPane */,
    );
    this.contentElement.classList.toggle(
      'no-pointer-events',
      pointerEventsBehavior === 'PierceContents' /* PointerEventsBehavior.PierceContents */,
    );
  }
