...
export declare function installDragHandle(
  element: Element,
...
export declare function elementDragStart(
...
export declare function createReplacementString(
  wordString: string,
  event: Event,
  customNumberHandler?: (arg0: string, arg1: number, arg2: string) => string,
): string | null;
export declare function handleElementValueModifications(
  event: Event,
  element: Element,
  finishHandler?: (arg0: string, arg1: string) => void,
...
export declare function asyncStackTraceLabel(
...
export declare function highlightSearchResult(
  element: Element,
  offset: number,
  length: number,
  domChanges?: HighlightChange[],
): Element | null;
export declare function highlightSearchResults(
  element: Element,
  resultRanges: TextUtils.TextRange.SourceRange[],
  changes?: HighlightChange[],
): Element[];
export declare function runCSSAnimationOnce(element: Element, className: string): void;
export declare function highlightRangesWithStyleClass(
  element: Element,
  resultRanges: TextUtils.TextRange.SourceRange[],
  styleClass: string,
  changes?: HighlightChange[],
...
export declare function animateFunction(
  window: Window,
  func: Function,
  params: {
    from: number;
...
export declare function createTextButton(
  text: string,
  eventHandler?: (arg0: Event) => void,
  className?: string,
  primary?: boolean,
...
export declare function createSelect(
  name: string,
  options: string[] | Map<string, string[]>[] | Set<string>,
): HTMLSelectElement;
...
export declare function bindInput(
...
export declare function trimText(
 ...
 */
export declare function addReferrerToURLIfNecessary(
...
export declare const deepElementFromPoint: (
  document: Document | ShadowRoot | null | undefined,
  x: number,
  y: number,
) => Node | null;
