...
export class ContrastDetails extends Common.ObjectWrapper.ObjectWrapper {
  ...
  constructor(
    ...
    this.bgColorPickerButton.addEventListener(
      ...
      this.toggleBackgroundColorPickerInternal.bind(this, undefined, true),
    );
    ...
    this.contrastInfo.addEventListener(
      'ContrastInfoUpdated' /* ContrastInfoEvents.ContrastInfoUpdated */,
  ...
  createFixColorButton(parent, suggestedColor) {
    ...
    const colorFormat =
      originalColorFormat &&
      originalColorFormat !== Common.Color.Format.Nickname &&
  ...
  toggleBackgroundColorPickerInternal(enabled, shouldTriggerEvent = true) {
    ...
    if (shouldTriggerEvent) {
      this.dispatchEventToListeners(
        'BackgroundColorPickerWillBeToggled' /* Events.BackgroundColorPickerWillBeToggled */,
        enabled,
      );
    }
