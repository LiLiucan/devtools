...
export class ContrastInfo extends Common.ObjectWrapper.ObjectWrapper {
  ...
  constructor(contrastInfo) {
    ...
    this.contrastRationAPCAThreshold = Common.ColorUtils.getAPCAThreshold(
      contrastInfo.computedFontSize,
      contrastInfo.computedFontWeight,
    );
  ...
  setBgColorInternal(bgColor) {
    ...
    this.contrastRatioAPCAInternal = Common.ColorUtils.contrastRatioAPCA(
      this.fgColor.rgba(),
      this.bgColorInternal.rgba(),
    );
  }
  bgColor() {
