...
declare const ViewportDataGrid_base: (new (...args: any[]) => {
  ...
  addEventListener<T_1 extends Events.ViewportCalculated>(
    eventType: T_1,
    listener: (arg0: Common.EventTarget.EventTargetEvent<EventTypes[T_1]>) => void,
    thisObject?: Object | undefined,
  ): Common.EventTarget.EventDescriptor<EventTypes, T_1>;
  once<T_1 extends Events.ViewportCalculated>(eventType: T_1): Promise<EventTypes[T_1]>;
  removeEventListener<T_2 extends Events.ViewportCalculated>(
    eventType: T_2,
  ...
  dispatchEventToListeners<T_3 extends Events.ViewportCalculated>(
