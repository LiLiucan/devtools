...
declare const BezierEditor_base: (new (...args: any[]) => {
  ...
  addEventListener<T extends Events.BezierChanged>(
    eventType: T,
  ...
  removeEventListener<T_2 extends Events.BezierChanged>(
    eventType: T_2,
  ...
  dispatchEventToListeners<T_3 extends Events.BezierChanged>(
