...
declare const CSSShadowEditor_base: (new (...args: any[]) => {
  ...
  addEventListener<T extends Events.ShadowChanged>(
    eventType: T,
  ...
  removeEventListener<T_2 extends Events.ShadowChanged>(
    eventType: T_2,
  ...
  dispatchEventToListeners<T_3 extends Events.ShadowChanged>(
