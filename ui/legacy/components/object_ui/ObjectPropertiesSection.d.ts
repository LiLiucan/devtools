...
export declare class ObjectPropertiesSection extends UI.TreeOutline.TreeOutlineInShadow {
  ...
  static getPropertyValuesByNames(
    properties: SDK.RemoteObject.RemoteObjectProperty[],
...
export declare class RootElement extends UI.TreeOutline.TreeElement {
  ...
  constructor(
    ...
    propertiesMode?: ObjectPropertiesMode,
    extraProperties?: SDK.RemoteObject.RemoteObjectProperty[],
    targetObject?: SDK.RemoteObject.RemoteObject,
  );
  onexpand(): void;
  oncollapse(): void;
...
export declare class ObjectPropertyTreeElement extends UI.TreeOutline.TreeElement {
  ...
  static populate(
    ...
    propertiesMode?: ObjectPropertiesMode,
    extraProperties?: SDK.RemoteObject.RemoteObjectProperty[],
    targetValue?: SDK.RemoteObject.RemoteObject,
  ): Promise<void>;
...
export declare class Renderer implements UI.UIUtils.Renderer {
  static instance(opts?: { forceNew: boolean }): Renderer;
  render(
    object: Object,
    options?: UI.UIUtils.Options,
  ): Promise<{
    node: Node;
