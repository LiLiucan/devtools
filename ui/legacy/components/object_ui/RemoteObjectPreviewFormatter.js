...
export class RemoteObjectPreviewFormatter {
  static objectPropertyComparator(a, b) {
    ...
    function sortValue(property) {
      ...
      if (
        property.name === '[[GeneratorState]]' /* InternalName.GeneratorState */ ||
        property.name === '[[PrimitiveValue]]' /* InternalName.PrimitiveValue */ ||
  ...
  appendObjectPropertiesPreview(parentElement, preview) {
    ...
    for (let i = 0; i < properties.length; ++i) {
      ...
      if (
        ...
        name === '[[PromiseState]]' /* InternalName.PromiseState */
      ) {
