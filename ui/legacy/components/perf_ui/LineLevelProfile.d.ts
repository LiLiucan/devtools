...
export declare class Performance {
  ...
  private constructor();
  static instance(opts?: { forceNew: boolean | null }): Performance;
  reset(): void;
...
export declare class Memory {
  private readonly helper;
  private constructor();
  static instance(opts?: { forceNew: boolean | null }): Memory;
  reset(): void;
...
export declare class Helper {
  ...
  addLineData(
    ...
    scriptIdOrUrl: Platform.DevToolsPath.UrlString | number,
    line: number,
    data: number,
  ): void;
  scheduleUpdate(): void;
