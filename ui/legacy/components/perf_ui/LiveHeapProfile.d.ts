...
export declare class LiveHeapProfile
  implements Common.Runnable.Runnable, SDK.TargetManager.SDKModelObserver<SDK.HeapProfilerModel.HeapProfilerModel>
{
  private running;
  private sessionId;
  ...
  private constructor();
  static instance(opts?: { forceNew: boolean | null }): LiveHeapProfile;
  run(): Promise<void>;
