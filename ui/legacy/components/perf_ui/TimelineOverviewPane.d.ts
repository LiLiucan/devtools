...
declare const TimelineOverviewPane_base: (new (...args: any[]) => {
  ...
  addEventListener<T extends Events.WindowChanged>(
    eventType: T,
  ...
  removeEventListener<T_2 extends Events.WindowChanged>(
    eventType: T_2,
  ...
  dispatchEventToListeners<T_3 extends Events.WindowChanged>(
