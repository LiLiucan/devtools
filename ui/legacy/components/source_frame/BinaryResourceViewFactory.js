...
export class BinaryResourceViewFactory {
  ...
  createHexView() {
    ...
    return new ResourceSourceFrame(hexViewerContentProvider, this.resourceType.canonicalMimeType(), {
      lineNumbers: false,
      lineWrapping: false,
    });
  }
  createUtf8View() {
    ...
    return new ResourceSourceFrame(utf8ContentProvider, this.resourceType.canonicalMimeType(), {
      lineNumbers: true,
      lineWrapping: true,
    });
  }
