...
declare function simplifyMimeType(content: string | CodeMirror.Text, mimeType: string): string;
...
export declare class SourceFrameImpl
  extends SourceFrameImpl_base
  implements UI.SearchableView.Searchable, UI.SearchableView.Replaceable, Transformer
{
  ...
  protected populateTextAreaContextMenu(
    _menu: UI.ContextMenu.ContextMenu,
    _lineNumber: number,
...
export declare const TEST_ONLY: {
  simplifyMimeType: typeof simplifyMimeType;
};
export {};
