...
export class ImagePreview {
  static async build(
    ...
    originalImageURL,
    showDimensions,
    options = { precomputedFeatures: undefined, imageAltText: undefined },
  ) {
    ...
    return new Promise((resolve) => {
      ...
      function buildContent() {
        ...
        if (showDimensions) {
          ...
          aspectRatioRow.createChild('td', 'description').textContent = Platform.NumberUtilities.aspectRatio(
            renderedWidth,
            renderedHeight,
          );
          if (renderedHeight !== intrinsicHeight || renderedWidth !== intrinsicWidth) {
            ...
            intrinsicAspectRatioRow.createChild('td', 'description').textContent = Platform.NumberUtilities.aspectRatio(
              intrinsicWidth,
              intrinsicHeight,
            );
          }
