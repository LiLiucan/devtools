...
export declare class Linkifier implements SDK.TargetManager.Observer {
  ...
  static linkifyRevealable(
    ...
    fallbackHref?: Platform.DevToolsPath.UrlString,
    title?: string,
    className?: string,
  ): HTMLElement;
